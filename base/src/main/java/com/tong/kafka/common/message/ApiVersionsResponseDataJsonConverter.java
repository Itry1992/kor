...
public class ApiVersionsResponseDataJsonConverter {
    public static ApiVersionsResponseData read(JsonNode _node, short _version) {
        ...
        if (_apiKeysNode == null) {
            ...
            ApiVersionsResponseData.ApiVersionCollection _collection = new ApiVersionsResponseData.ApiVersionCollection(_apiKeysNode.size());
        ...
        if (_supportedFeaturesNode == null) {
            _object.supportedFeatures = new ApiVersionsResponseData.SupportedFeatureKeyCollection(0);
        } else {
            if (!_supportedFeaturesNode.isArray()) {
                throw new RuntimeException("ApiVersionsResponseData expected a JSON array, but got " + _node.getNodeType());
            }
            ApiVersionsResponseData.SupportedFeatureKeyCollection _collection = new ApiVersionsResponseData.SupportedFeatureKeyCollection(_supportedFeaturesNode.size());
        ...
        if (_finalizedFeaturesNode == null) {
            _object.finalizedFeatures = new ApiVersionsResponseData.FinalizedFeatureKeyCollection(0);
        } else {
            if (!_finalizedFeaturesNode.isArray()) {
                throw new RuntimeException("ApiVersionsResponseData expected a JSON array, but got " + _node.getNodeType());
            }
            ApiVersionsResponseData.FinalizedFeatureKeyCollection _collection = new ApiVersionsResponseData.FinalizedFeatureKeyCollection(_finalizedFeaturesNode.size());
    ...
    public static JsonNode write(ApiVersionsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (ApiVersionsResponseData.ApiVersion _element : _object.apiKeys) {
        ...
        if (_version >= 3) {
            if (!_object.supportedFeatures.isEmpty()) {
                ...
                for (ApiVersionsResponseData.SupportedFeatureKey _element : _object.supportedFeatures) {
        ...
        if (_version >= 3) {
            if (!_object.finalizedFeatures.isEmpty()) {
                ...
                for (ApiVersionsResponseData.FinalizedFeatureKey _element : _object.finalizedFeatures) {
    ...
    public static class ApiVersionJsonConverter {
        public static ApiVersionsResponseData.ApiVersion read(JsonNode _node, short _version) {
            ApiVersionsResponseData.ApiVersion _object = new ApiVersionsResponseData.ApiVersion();
        ...
        public static JsonNode write(ApiVersionsResponseData.ApiVersion _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(ApiVersionsResponseData.ApiVersion _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class FinalizedFeatureKeyJsonConverter {
        public static ApiVersionsResponseData.FinalizedFeatureKey read(JsonNode _node, short _version) {
            ApiVersionsResponseData.FinalizedFeatureKey _object = new ApiVersionsResponseData.FinalizedFeatureKey();
            if (_version < 3) {
        ...
        public static JsonNode write(ApiVersionsResponseData.FinalizedFeatureKey _object, short _version, boolean _serializeRecords) {
            if (_version < 3) {
        ...
        public static JsonNode write(ApiVersionsResponseData.FinalizedFeatureKey _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class SupportedFeatureKeyJsonConverter {
        public static ApiVersionsResponseData.SupportedFeatureKey read(JsonNode _node, short _version) {
            ApiVersionsResponseData.SupportedFeatureKey _object = new ApiVersionsResponseData.SupportedFeatureKey();
            if (_version < 3) {
        ...
        public static JsonNode write(ApiVersionsResponseData.SupportedFeatureKey _object, short _version, boolean _serializeRecords) {
            if (_version < 3) {
        ...
        public static JsonNode write(ApiVersionsResponseData.SupportedFeatureKey _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
