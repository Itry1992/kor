 ...
 */
package com.tong.kafka.common.serialization;
...
import com.tong.kafka.common.serialization.Serdes.ListSerde;
...
import static com.tong.kafka.common.serialization.Serdes.ListSerde.SerializationStrategy;
...
public class ListDeserializer<Inner> implements Deserializer<List<Inner>> {
    ...
    private static final Map<Class<? extends Deserializer<?>>, Integer> FIXED_LENGTH_DESERIALIZERS = Utils.mkMap(
        Utils.mkEntry(ShortDeserializer.class, Short.BYTES),
        Utils.mkEntry(IntegerDeserializer.class, Integer.BYTES),
        Utils.mkEntry(FloatDeserializer.class, Float.BYTES),
        Utils.mkEntry(LongDeserializer.class, Long.BYTES),
        Utils.mkEntry(DoubleDeserializer.class, Double.BYTES),
        Utils.mkEntry(UUIDDeserializer.class, 36)
    );
