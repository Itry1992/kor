...
public class DescribeLogDirsRequestDataJsonConverter {
    public static DescribeLogDirsRequestData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            if (_topicsNode.isNull()) {
                ...
                DescribeLogDirsRequestData.DescribableLogDirTopicCollection _collection = new DescribeLogDirsRequestData.DescribableLogDirTopicCollection(_topicsNode.size());
    ...
    public static JsonNode write(DescribeLogDirsRequestData _object, short _version, boolean _serializeRecords) {
        ...
        if (_object.topics == null) {
            ...
            for (DescribeLogDirsRequestData.DescribableLogDirTopic _element : _object.topics) {
    ...
    public static class DescribableLogDirTopicJsonConverter {
        public static DescribeLogDirsRequestData.DescribableLogDirTopic read(JsonNode _node, short _version) {
            DescribeLogDirsRequestData.DescribableLogDirTopic _object = new DescribeLogDirsRequestData.DescribableLogDirTopic();
        ...
        public static JsonNode write(DescribeLogDirsRequestData.DescribableLogDirTopic _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeLogDirsRequestData.DescribableLogDirTopic _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
