...
public class LeaderAndIsrResponseDataJsonConverter {
    public static LeaderAndIsrResponseData read(JsonNode _node, short _version) {
        ...
        if (_partitionErrorsNode == null) {
            if (_version <= 4) {
                ...
                _object.partitionErrors = new ArrayList<LeaderAndIsrResponseData.LeaderAndIsrPartitionError>(0);
            }
        } else {
            ...
            ArrayList<LeaderAndIsrResponseData.LeaderAndIsrPartitionError> _collection = new ArrayList<LeaderAndIsrResponseData.LeaderAndIsrPartitionError>(_partitionErrorsNode.size());
        ...
        if (_topicsNode == null) {
            if (_version >= 5) {
                ...
                _object.topics = new LeaderAndIsrResponseData.LeaderAndIsrTopicErrorCollection(0);
            }
        } else {
            if (!_topicsNode.isArray()) {
                throw new RuntimeException("LeaderAndIsrResponseData expected a JSON array, but got " + _node.getNodeType());
            }
            LeaderAndIsrResponseData.LeaderAndIsrTopicErrorCollection _collection = new LeaderAndIsrResponseData.LeaderAndIsrTopicErrorCollection(_topicsNode.size());
    ...
    public static JsonNode write(LeaderAndIsrResponseData _object, short _version, boolean _serializeRecords) {
        ...
        if (_version <= 4) {
            ...
            for (LeaderAndIsrResponseData.LeaderAndIsrPartitionError _element : _object.partitionErrors) {
        ...
        if (_version >= 5) {
            ...
            for (LeaderAndIsrResponseData.LeaderAndIsrTopicError _element : _object.topics) {
    ...
    public static class LeaderAndIsrPartitionErrorJsonConverter {
        public static LeaderAndIsrResponseData.LeaderAndIsrPartitionError read(JsonNode _node, short _version) {
            LeaderAndIsrResponseData.LeaderAndIsrPartitionError _object = new LeaderAndIsrResponseData.LeaderAndIsrPartitionError();
        ...
        public static JsonNode write(LeaderAndIsrResponseData.LeaderAndIsrPartitionError _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            if (_version <= 4) {
        ...
        public static JsonNode write(LeaderAndIsrResponseData.LeaderAndIsrPartitionError _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class LeaderAndIsrTopicErrorJsonConverter {
        public static LeaderAndIsrResponseData.LeaderAndIsrTopicError read(JsonNode _node, short _version) {
            LeaderAndIsrResponseData.LeaderAndIsrTopicError _object = new LeaderAndIsrResponseData.LeaderAndIsrTopicError();
            if (_version < 5) {
        ...
        public static JsonNode write(LeaderAndIsrResponseData.LeaderAndIsrTopicError _object, short _version, boolean _serializeRecords) {
            if (_version < 5) {
        ...
        public static JsonNode write(LeaderAndIsrResponseData.LeaderAndIsrTopicError _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
