...
public class AlterConfigsResponseDataJsonConverter {
    public static AlterConfigsResponseData read(JsonNode _node, short _version) {
        ...
        if (_responsesNode == null) {
            ...
            ArrayList<AlterConfigsResponseData.AlterConfigsResourceResponse> _collection = new ArrayList<AlterConfigsResponseData.AlterConfigsResourceResponse>(_responsesNode.size());
    ...
    public static JsonNode write(AlterConfigsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (AlterConfigsResponseData.AlterConfigsResourceResponse _element : _object.responses) {
    ...
    public static class AlterConfigsResourceResponseJsonConverter {
        public static AlterConfigsResponseData.AlterConfigsResourceResponse read(JsonNode _node, short _version) {
            AlterConfigsResponseData.AlterConfigsResourceResponse _object = new AlterConfigsResponseData.AlterConfigsResourceResponse();
        ...
        public static JsonNode write(AlterConfigsResponseData.AlterConfigsResourceResponse _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(AlterConfigsResponseData.AlterConfigsResourceResponse _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
