...
import com.tong.kafka.common.message.UpdateFeaturesResponseData;
...
public class UpdateFeaturesResponse extends AbstractResponse {
    ...
    public Map<Errors, Integer> errorCounts() {
        ...
        for (UpdateFeaturesResponseData.UpdatableFeatureResult result : data.results()) {
    ...
    public static UpdateFeaturesResponse createWithErrors(ApiError topLevelError, Map<String, ApiError> updateErrors, int throttleTimeMs) {
        final UpdateFeaturesResponseData.UpdatableFeatureResultCollection results = new UpdateFeaturesResponseData.UpdatableFeatureResultCollection();
        for (final Map.Entry<String, ApiError> updateError : updateErrors.entrySet()) {
            ...
            final UpdateFeaturesResponseData.UpdatableFeatureResult result = new UpdateFeaturesResponseData.UpdatableFeatureResult();
