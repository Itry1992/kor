...
import com.tong.kafka.common.acl.AccessControlEntryFilter;
import com.tong.kafka.common.acl.AclBindingFilter;
import com.tong.kafka.common.message.DeleteAclsRequestData;
...
public class DeleteAclsRequest extends AbstractRequest {
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable throwable) {
        ...
        List<DeleteAclsResponseData.DeleteAclsFilterResult> filterResults = Collections.nCopies(data.filters().size(),
