...
public class OffsetForLeaderEpochResponseDataJsonConverter {
    public static OffsetForLeaderEpochResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResultCollection _collection = new OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResultCollection(_topicsNode.size());
    ...
    public static JsonNode write(OffsetForLeaderEpochResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult _element : _object.topics) {
    ...
    public static class EpochEndOffsetJsonConverter {
        public static OffsetForLeaderEpochResponseData.EpochEndOffset read(JsonNode _node, short _version) {
            OffsetForLeaderEpochResponseData.EpochEndOffset _object = new OffsetForLeaderEpochResponseData.EpochEndOffset();
        ...
        public static JsonNode write(OffsetForLeaderEpochResponseData.EpochEndOffset _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(OffsetForLeaderEpochResponseData.EpochEndOffset _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetForLeaderTopicResultJsonConverter {
        public static OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult read(JsonNode _node, short _version) {
            OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult _object = new OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<OffsetForLeaderEpochResponseData.EpochEndOffset> _collection = new ArrayList<OffsetForLeaderEpochResponseData.EpochEndOffset>(_partitionsNode.size());
        ...
        public static JsonNode write(OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("topic", new TextNode(_object.topic));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (OffsetForLeaderEpochResponseData.EpochEndOffset _element : _object.partitions) {
                _partitionsArray.add(EpochEndOffsetJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
