...
import com.tong.kafka.common.utils.Checksums;
...
public final class LegacyRecord {
    ...
    public static LegacyRecord create(byte magic,
        ...
        write(buffer, magic, timestamp, Utils.wrapNullable(key), Utils.wrapNullable(value), compressionType, timestampType);
        buffer.rewind();
    ...
    public static long write(DataOutputStream out,
        ...
        return write(out, magic, timestamp, Utils.wrapNullable(key), Utils.wrapNullable(value), compressionType, timestampType);
    }
    ...
    public static void write(DataOutputStream out,
        ...
        write(out, magic, crc, attributes, timestamp, Utils.wrapNullable(key), Utils.wrapNullable(value));
    }
    ...
    public static long computeChecksum(byte magic, byte attributes, long timestamp, byte[] key, byte[] value) {
        return computeChecksum(magic, attributes, timestamp, Utils.wrapNullable(key), Utils.wrapNullable(value));
    }
