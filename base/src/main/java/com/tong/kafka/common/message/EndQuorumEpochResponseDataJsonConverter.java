...
public class EndQuorumEpochResponseDataJsonConverter {
    public static EndQuorumEpochResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            ArrayList<EndQuorumEpochResponseData.TopicData> _collection = new ArrayList<EndQuorumEpochResponseData.TopicData>(_topicsNode.size());
    ...
    public static JsonNode write(EndQuorumEpochResponseData _object, short _version, boolean _serializeRecords) {
        ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        _node.set("errorCode", new ShortNode(_object.errorCode));
        ArrayNode _topicsArray = new ArrayNode(JsonNodeFactory.instance);
        for (EndQuorumEpochResponseData.TopicData _element : _object.topics) {
    ...
    public static class PartitionDataJsonConverter {
        public static EndQuorumEpochResponseData.PartitionData read(JsonNode _node, short _version) {
            EndQuorumEpochResponseData.PartitionData _object = new EndQuorumEpochResponseData.PartitionData();
        ...
        public static JsonNode write(EndQuorumEpochResponseData.PartitionData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(EndQuorumEpochResponseData.PartitionData _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class TopicDataJsonConverter {
        public static EndQuorumEpochResponseData.TopicData read(JsonNode _node, short _version) {
            EndQuorumEpochResponseData.TopicData _object = new EndQuorumEpochResponseData.TopicData();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<EndQuorumEpochResponseData.PartitionData> _collection = new ArrayList<EndQuorumEpochResponseData.PartitionData>(_partitionsNode.size());
        ...
        public static JsonNode write(EndQuorumEpochResponseData.TopicData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("topicName", new TextNode(_object.topicName));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (EndQuorumEpochResponseData.PartitionData _element : _object.partitions) {
                _partitionsArray.add(PartitionDataJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(EndQuorumEpochResponseData.TopicData _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
