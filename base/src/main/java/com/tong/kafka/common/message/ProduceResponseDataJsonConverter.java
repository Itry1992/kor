...
public class ProduceResponseDataJsonConverter {
    public static ProduceResponseData read(JsonNode _node, short _version) {
        ...
        if (_responsesNode == null) {
            ...
            ProduceResponseData.TopicProduceResponseCollection _collection = new ProduceResponseData.TopicProduceResponseCollection(_responsesNode.size());
    ...
    public static JsonNode write(ProduceResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (ProduceResponseData.TopicProduceResponse _element : _object.responses) {
    ...
    public static class BatchIndexAndErrorMessageJsonConverter {
        public static ProduceResponseData.BatchIndexAndErrorMessage read(JsonNode _node, short _version) {
            ProduceResponseData.BatchIndexAndErrorMessage _object = new ProduceResponseData.BatchIndexAndErrorMessage();
            if (_version < 8) {
        ...
        public static JsonNode write(ProduceResponseData.BatchIndexAndErrorMessage _object, short _version, boolean _serializeRecords) {
            if (_version < 8) {
        ...
        public static JsonNode write(ProduceResponseData.BatchIndexAndErrorMessage _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class PartitionProduceResponseJsonConverter {
        public static ProduceResponseData.PartitionProduceResponse read(JsonNode _node, short _version) {
            ProduceResponseData.PartitionProduceResponse _object = new ProduceResponseData.PartitionProduceResponse();
            ...
            if (_recordErrorsNode == null) {
                if (_version >= 8) {
                    ...
                    _object.recordErrors = new ArrayList<ProduceResponseData.BatchIndexAndErrorMessage>(0);
                }
            } else {
                ...
                ArrayList<ProduceResponseData.BatchIndexAndErrorMessage> _collection = new ArrayList<ProduceResponseData.BatchIndexAndErrorMessage>(_recordErrorsNode.size());
        ...
        public static JsonNode write(ProduceResponseData.PartitionProduceResponse _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            if (_version >= 8) {
                ...
                for (ProduceResponseData.BatchIndexAndErrorMessage _element : _object.recordErrors) {
        ...
        public static JsonNode write(ProduceResponseData.PartitionProduceResponse _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class TopicProduceResponseJsonConverter {
        public static ProduceResponseData.TopicProduceResponse read(JsonNode _node, short _version) {
            ProduceResponseData.TopicProduceResponse _object = new ProduceResponseData.TopicProduceResponse();
            ...
            if (_partitionResponsesNode == null) {
                ...
                ArrayList<ProduceResponseData.PartitionProduceResponse> _collection = new ArrayList<ProduceResponseData.PartitionProduceResponse>(_partitionResponsesNode.size());
        ...
        public static JsonNode write(ProduceResponseData.TopicProduceResponse _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionResponsesArray = new ArrayNode(JsonNodeFactory.instance);
            for (ProduceResponseData.PartitionProduceResponse _element : _object.partitionResponses) {
        ...
        public static JsonNode write(ProduceResponseData.TopicProduceResponse _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
