...
public class VoteRequestDataJsonConverter {
    public static VoteRequestData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            ArrayList<VoteRequestData.TopicData> _collection = new ArrayList<VoteRequestData.TopicData>(_topicsNode.size());
    ...
    public static JsonNode write(VoteRequestData _object, short _version, boolean _serializeRecords) {
        ...
        for (VoteRequestData.TopicData _element : _object.topics) {
    ...
    public static class PartitionDataJsonConverter {
        public static VoteRequestData.PartitionData read(JsonNode _node, short _version) {
            VoteRequestData.PartitionData _object = new VoteRequestData.PartitionData();
        ...
        public static JsonNode write(VoteRequestData.PartitionData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(VoteRequestData.PartitionData _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class TopicDataJsonConverter {
        public static VoteRequestData.TopicData read(JsonNode _node, short _version) {
            VoteRequestData.TopicData _object = new VoteRequestData.TopicData();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<VoteRequestData.PartitionData> _collection = new ArrayList<VoteRequestData.PartitionData>(_partitionsNode.size());
        ...
        public static JsonNode write(VoteRequestData.TopicData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("topicName", new TextNode(_object.topicName));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (VoteRequestData.PartitionData _element : _object.partitions) {
                _partitionsArray.add(PartitionDataJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(VoteRequestData.TopicData _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
