...
public class AlterClientQuotasResponseDataJsonConverter {
    public static AlterClientQuotasResponseData read(JsonNode _node, short _version) {
        ...
        if (_entriesNode == null) {
            ...
            ArrayList<AlterClientQuotasResponseData.EntryData> _collection = new ArrayList<AlterClientQuotasResponseData.EntryData>(_entriesNode.size());
    ...
    public static JsonNode write(AlterClientQuotasResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (AlterClientQuotasResponseData.EntryData _element : _object.entries) {
    ...
    public static class EntityDataJsonConverter {
        public static AlterClientQuotasResponseData.EntityData read(JsonNode _node, short _version) {
            AlterClientQuotasResponseData.EntityData _object = new AlterClientQuotasResponseData.EntityData();
        ...
        public static JsonNode write(AlterClientQuotasResponseData.EntityData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(AlterClientQuotasResponseData.EntityData _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class EntryDataJsonConverter {
        public static AlterClientQuotasResponseData.EntryData read(JsonNode _node, short _version) {
            AlterClientQuotasResponseData.EntryData _object = new AlterClientQuotasResponseData.EntryData();
            ...
            if (_entityNode == null) {
                ...
                ArrayList<AlterClientQuotasResponseData.EntityData> _collection = new ArrayList<AlterClientQuotasResponseData.EntityData>(_entityNode.size());
        ...
        public static JsonNode write(AlterClientQuotasResponseData.EntryData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (AlterClientQuotasResponseData.EntityData _element : _object.entity) {
                _entityArray.add(EntityDataJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("entity", _entityArray);
            return _node;
        }
        public static JsonNode write(AlterClientQuotasResponseData.EntryData _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
