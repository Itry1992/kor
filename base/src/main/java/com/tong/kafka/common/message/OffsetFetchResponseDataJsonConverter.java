...
public class OffsetFetchResponseDataJsonConverter {
    public static OffsetFetchResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            if (_version <= 7) {
                ...
                _object.topics = new ArrayList<OffsetFetchResponseData.OffsetFetchResponseTopic>(0);
            }
        } else {
            if (!_topicsNode.isArray()) {
                throw new RuntimeException("OffsetFetchResponseData expected a JSON array, but got " + _node.getNodeType());
            }
            ArrayList<OffsetFetchResponseData.OffsetFetchResponseTopic> _collection = new ArrayList<OffsetFetchResponseData.OffsetFetchResponseTopic>(_topicsNode.size());
        ...
        if (_groupsNode == null) {
            if (_version >= 8) {
                ...
                _object.groups = new ArrayList<OffsetFetchResponseData.OffsetFetchResponseGroup>(0);
            }
        } else {
            if (!_groupsNode.isArray()) {
                throw new RuntimeException("OffsetFetchResponseData expected a JSON array, but got " + _node.getNodeType());
            }
            ArrayList<OffsetFetchResponseData.OffsetFetchResponseGroup> _collection = new ArrayList<OffsetFetchResponseData.OffsetFetchResponseGroup>(_groupsNode.size());
    ...
    public static JsonNode write(OffsetFetchResponseData _object, short _version, boolean _serializeRecords) {
        ...
        if (_version <= 7) {
            ...
            for (OffsetFetchResponseData.OffsetFetchResponseTopic _element : _object.topics) {
        ...
        if (_version >= 8) {
            ...
            for (OffsetFetchResponseData.OffsetFetchResponseGroup _element : _object.groups) {
    ...
    public static class OffsetFetchResponseGroupJsonConverter {
        public static OffsetFetchResponseData.OffsetFetchResponseGroup read(JsonNode _node, short _version) {
            OffsetFetchResponseData.OffsetFetchResponseGroup _object = new OffsetFetchResponseData.OffsetFetchResponseGroup();
            if (_version < 8) {
            ...
            if (_topicsNode == null) {
                ...
                ArrayList<OffsetFetchResponseData.OffsetFetchResponseTopics> _collection = new ArrayList<OffsetFetchResponseData.OffsetFetchResponseTopics>(_topicsNode.size());
                _object.topics = _collection;
                for (JsonNode _element : _topicsNode) {
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponseGroup _object, short _version, boolean _serializeRecords) {
            if (_version < 8) {
            ...
            ArrayNode _topicsArray = new ArrayNode(JsonNodeFactory.instance);
            for (OffsetFetchResponseData.OffsetFetchResponseTopics _element : _object.topics) {
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponseGroup _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetFetchResponsePartitionJsonConverter {
        public static OffsetFetchResponseData.OffsetFetchResponsePartition read(JsonNode _node, short _version) {
            OffsetFetchResponseData.OffsetFetchResponsePartition _object = new OffsetFetchResponseData.OffsetFetchResponsePartition();
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponsePartition _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponsePartition _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetFetchResponsePartitionsJsonConverter {
        public static OffsetFetchResponseData.OffsetFetchResponsePartitions read(JsonNode _node, short _version) {
            OffsetFetchResponseData.OffsetFetchResponsePartitions _object = new OffsetFetchResponseData.OffsetFetchResponsePartitions();
            JsonNode _partitionIndexNode = _node.get("partitionIndex");
            if (_partitionIndexNode == null) {
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponsePartitions _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("partitionIndex", new IntNode(_object.partitionIndex));
            _node.set("committedOffset", new LongNode(_object.committedOffset));
            _node.set("committedLeaderEpoch", new IntNode(_object.committedLeaderEpoch));
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponsePartitions _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetFetchResponseTopicJsonConverter {
        public static OffsetFetchResponseData.OffsetFetchResponseTopic read(JsonNode _node, short _version) {
            OffsetFetchResponseData.OffsetFetchResponseTopic _object = new OffsetFetchResponseData.OffsetFetchResponseTopic();
            if (_version > 7) {
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<OffsetFetchResponseData.OffsetFetchResponsePartition> _collection = new ArrayList<OffsetFetchResponseData.OffsetFetchResponsePartition>(_partitionsNode.size());
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponseTopic _object, short _version, boolean _serializeRecords) {
            if (_version > 7) {
            ...
            for (OffsetFetchResponseData.OffsetFetchResponsePartition _element : _object.partitions) {
                _partitionsArray.add(OffsetFetchResponsePartitionJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponseTopic _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetFetchResponseTopicsJsonConverter {
        public static OffsetFetchResponseData.OffsetFetchResponseTopics read(JsonNode _node, short _version) {
            OffsetFetchResponseData.OffsetFetchResponseTopics _object = new OffsetFetchResponseData.OffsetFetchResponseTopics();
            JsonNode _nameNode = _node.get("name");
            if (_nameNode == null) {
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<OffsetFetchResponseData.OffsetFetchResponsePartitions> _collection = new ArrayList<OffsetFetchResponseData.OffsetFetchResponsePartitions>(_partitionsNode.size());
                _object.partitions = _collection;
                for (JsonNode _element : _partitionsNode) {
        ...
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponseTopics _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (OffsetFetchResponseData.OffsetFetchResponsePartitions _element : _object.partitions) {
                _partitionsArray.add(OffsetFetchResponsePartitionsJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(OffsetFetchResponseData.OffsetFetchResponseTopics _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
