...
package com.tong.kafka.common.security.oauthbearer.secured;
...
import com.tong.kafka.common.security.auth.SaslExtensions;
import com.tong.kafka.common.security.auth.SaslExtensionsCallback;
import com.tong.kafka.common.security.oauthbearer.OAuthBearerToken;
import com.tong.kafka.common.security.oauthbearer.OAuthBearerTokenCallback;
import com.tong.kafka.common.security.oauthbearer.internals.OAuthBearerClientInitialResponse;
 ...
 * {@link SaslConfigs#SASL_LOGIN_CALLBACK_HANDLER_CLASS}
 ...
 *
 * <ul>
 *   <li>{@link SaslConfigs#SASL_LOGIN_CALLBACK_HANDLER_CLASS}</li>
 *   <li>{@link SaslConfigs#SASL_LOGIN_CONNECT_TIMEOUT_MS}</li>
 *   <li>{@link SaslConfigs#SASL_LOGIN_READ_TIMEOUT_MS}</li>
 *   <li>{@link SaslConfigs#SASL_LOGIN_RETRY_BACKOFF_MS}</li>
 *   <li>{@link SaslConfigs#SASL_LOGIN_RETRY_BACKOFF_MAX_MS}</li>
 *   <li>{@link SaslConfigs#SASL_JAAS_CONFIG}</li>
 *   <li>{@link SaslConfigs#SASL_OAUTHBEARER_TOKEN_ENDPOINT_URL}</li>
 *   <li>{@link SaslConfigs#SASL_OAUTHBEARER_SCOPE_CLAIM_NAME}</li>
 *   <li>{@link SaslConfigs#SASL_OAUTHBEARER_SUB_CLAIM_NAME}</li>
 * </ul>
 * </p>
 */
...
public class OAuthBearerLoginCallbackHandler implements AuthenticateCallbackHandler {
    ...
    public static final String SCOPE_DOC = "The (optional) HTTP/HTTPS login request to the " +
        "token endpoint (" + SaslConfigs.SASL_OAUTHBEARER_TOKEN_ENDPOINT_URL + ") may need to specify an " +
