...
import com.tong.kafka.common.message.DescribeDelegationTokenResponseData;
...
public class DescribeDelegationTokenResponse extends AbstractResponse {
    ...
    public DescribeDelegationTokenResponse(int version, int throttleTimeMs, Errors error, List<DelegationToken> tokens) {
        ...
        List<DescribeDelegationTokenResponseData.DescribedDelegationToken> describedDelegationTokenList = tokens
            .stream()
            .map(dt -> {
                DescribeDelegationTokenResponseData.DescribedDelegationToken ddt = new DescribeDelegationTokenResponseData.DescribedDelegationToken()
                    ...
                    .setRenewers(dt.tokenInfo().renewers()
                        .stream()
                        .map(r -> new DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer().setPrincipalName(r.getName()).setPrincipalType(r.getPrincipalType()))
