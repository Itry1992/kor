...
public class DescribeConfigsRequestDataJsonConverter {
    public static DescribeConfigsRequestData read(JsonNode _node, short _version) {
        ...
        if (_resourcesNode == null) {
            ...
            ArrayList<DescribeConfigsRequestData.DescribeConfigsResource> _collection = new ArrayList<DescribeConfigsRequestData.DescribeConfigsResource>(_resourcesNode.size());
    ...
    public static JsonNode write(DescribeConfigsRequestData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeConfigsRequestData.DescribeConfigsResource _element : _object.resources) {
    ...
    public static class DescribeConfigsResourceJsonConverter {
        public static DescribeConfigsRequestData.DescribeConfigsResource read(JsonNode _node, short _version) {
            DescribeConfigsRequestData.DescribeConfigsResource _object = new DescribeConfigsRequestData.DescribeConfigsResource();
        ...
        public static JsonNode write(DescribeConfigsRequestData.DescribeConfigsResource _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeConfigsRequestData.DescribeConfigsResource _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
