...
public class AlterReplicaLogDirsResponseDataJsonConverter {
    public static AlterReplicaLogDirsResponseData read(JsonNode _node, short _version) {
        ...
        if (_resultsNode == null) {
            ...
            ArrayList<AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult> _collection = new ArrayList<AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult>(_resultsNode.size());
    ...
    public static JsonNode write(AlterReplicaLogDirsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult _element : _object.results) {
    ...
    public static class AlterReplicaLogDirPartitionResultJsonConverter {
        public static AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult read(JsonNode _node, short _version) {
            AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult _object = new AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult();
        ...
        public static JsonNode write(AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("partitionIndex", new IntNode(_object.partitionIndex));
            _node.set("errorCode", new ShortNode(_object.errorCode));
            return _node;
        }
        public static JsonNode write(AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class AlterReplicaLogDirTopicResultJsonConverter {
        public static AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult read(JsonNode _node, short _version) {
            AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult _object = new AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult> _collection = new ArrayList<AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult>(_partitionsNode.size());
        ...
        public static JsonNode write(AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("topicName", new TextNode(_object.topicName));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (AlterReplicaLogDirsResponseData.AlterReplicaLogDirPartitionResult _element : _object.partitions) {
                _partitionsArray.add(AlterReplicaLogDirPartitionResultJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(AlterReplicaLogDirsResponseData.AlterReplicaLogDirTopicResult _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
