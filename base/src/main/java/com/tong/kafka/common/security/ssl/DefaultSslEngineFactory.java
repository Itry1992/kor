 ...
 */
package com.tong.kafka.common.security.ssl;

import com.tong.kafka.common.config.SslClientAuth;
import com.tong.kafka.common.utils.SecurityUtils;
...
import com.tong.kafka.common.config.types.Password;
import com.tong.kafka.common.errors.InvalidConfigurationException;
import com.tong.kafka.common.network.Mode;
import com.tong.kafka.common.security.auth.SslEngineFactory;
    ...
    static class PemStore implements SecurityStore {
        ...
        private KeyStore createKeyStoreFromPem(String privateKeyPem, String certChainPem, char[] keyPassword) {
            try {
                ...
                ks.setKeyEntry("com/tong/kafka", key, keyPassword, certChain);
                return ks;
            } catch (Exception e) {
        ...
        private KeyStore createTrustStoreFromPem(String trustedCertsPem) {
            try {
                ...
                for (int i = 0; i < certs.length; i++) {
                    ts.setCertificateEntry("com/tong/kafka" + i, certs[i]);
                }
                return ts;
