...
public class OffsetFetchRequestDataJsonConverter {
    public static OffsetFetchRequestData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            if (_version <= 7) {
                ...
                _object.topics = new ArrayList<OffsetFetchRequestData.OffsetFetchRequestTopic>(0);
            }
        } else {
            if (_topicsNode.isNull()) {
                ...
                ArrayList<OffsetFetchRequestData.OffsetFetchRequestTopic> _collection = new ArrayList<OffsetFetchRequestData.OffsetFetchRequestTopic>(_topicsNode.size());
        ...
        if (_groupsNode == null) {
            if (_version >= 8) {
                ...
                _object.groups = new ArrayList<OffsetFetchRequestData.OffsetFetchRequestGroup>(0);
            }
        } else {
            if (!_groupsNode.isArray()) {
                throw new RuntimeException("OffsetFetchRequestData expected a JSON array, but got " + _node.getNodeType());
            }
            ArrayList<OffsetFetchRequestData.OffsetFetchRequestGroup> _collection = new ArrayList<OffsetFetchRequestData.OffsetFetchRequestGroup>(_groupsNode.size());
    ...
    public static JsonNode write(OffsetFetchRequestData _object, short _version, boolean _serializeRecords) {
        ...
        if (_version <= 7) {
            if (_object.topics == null) {
                ...
                for (OffsetFetchRequestData.OffsetFetchRequestTopic _element : _object.topics) {
        ...
        if (_version >= 8) {
            ...
            for (OffsetFetchRequestData.OffsetFetchRequestGroup _element : _object.groups) {
    ...
    public static class OffsetFetchRequestGroupJsonConverter {
        public static OffsetFetchRequestData.OffsetFetchRequestGroup read(JsonNode _node, short _version) {
            OffsetFetchRequestData.OffsetFetchRequestGroup _object = new OffsetFetchRequestData.OffsetFetchRequestGroup();
            if (_version < 8) {
            ...
            if (_topicsNode == null) {
                ...
                if (_topicsNode.isNull()) {
                    ...
                    ArrayList<OffsetFetchRequestData.OffsetFetchRequestTopics> _collection = new ArrayList<OffsetFetchRequestData.OffsetFetchRequestTopics>(_topicsNode.size());
                    _object.topics = _collection;
                    for (JsonNode _element : _topicsNode) {
        ...
        public static JsonNode write(OffsetFetchRequestData.OffsetFetchRequestGroup _object, short _version, boolean _serializeRecords) {
            if (_version < 8) {
            ...
            if (_object.topics == null) {
                ...
                ArrayNode _topicsArray = new ArrayNode(JsonNodeFactory.instance);
                for (OffsetFetchRequestData.OffsetFetchRequestTopics _element : _object.topics) {
        ...
        public static JsonNode write(OffsetFetchRequestData.OffsetFetchRequestGroup _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetFetchRequestTopicJsonConverter {
        public static OffsetFetchRequestData.OffsetFetchRequestTopic read(JsonNode _node, short _version) {
            OffsetFetchRequestData.OffsetFetchRequestTopic _object = new OffsetFetchRequestData.OffsetFetchRequestTopic();
            if (_version > 7) {
        ...
        public static JsonNode write(OffsetFetchRequestData.OffsetFetchRequestTopic _object, short _version, boolean _serializeRecords) {
            if (_version > 7) {
        ...
        public static JsonNode write(OffsetFetchRequestData.OffsetFetchRequestTopic _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetFetchRequestTopicsJsonConverter {
        public static OffsetFetchRequestData.OffsetFetchRequestTopics read(JsonNode _node, short _version) {
            OffsetFetchRequestData.OffsetFetchRequestTopics _object = new OffsetFetchRequestData.OffsetFetchRequestTopics();
            JsonNode _nameNode = _node.get("name");
            if (_nameNode == null) {
        ...
        public static JsonNode write(OffsetFetchRequestData.OffsetFetchRequestTopics _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionIndexesArray = new ArrayNode(JsonNodeFactory.instance);
            for (Integer _element : _object.partitionIndexes) {
        ...
        public static JsonNode write(OffsetFetchRequestData.OffsetFetchRequestTopics _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
