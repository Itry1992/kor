...
public class AlterPartitionReassignmentsResponseDataJsonConverter {
    public static AlterPartitionReassignmentsResponseData read(JsonNode _node, short _version) {
        ...
        if (_responsesNode == null) {
            ...
            ArrayList<AlterPartitionReassignmentsResponseData.ReassignableTopicResponse> _collection = new ArrayList<AlterPartitionReassignmentsResponseData.ReassignableTopicResponse>(_responsesNode.size());
    ...
    public static JsonNode write(AlterPartitionReassignmentsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (AlterPartitionReassignmentsResponseData.ReassignableTopicResponse _element : _object.responses) {
    ...
    public static class ReassignablePartitionResponseJsonConverter {
        public static AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse read(JsonNode _node, short _version) {
            AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse _object = new AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse();
        ...
        public static JsonNode write(AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class ReassignableTopicResponseJsonConverter {
        public static AlterPartitionReassignmentsResponseData.ReassignableTopicResponse read(JsonNode _node, short _version) {
            AlterPartitionReassignmentsResponseData.ReassignableTopicResponse _object = new AlterPartitionReassignmentsResponseData.ReassignableTopicResponse();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse> _collection = new ArrayList<AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse>(_partitionsNode.size());
        ...
        public static JsonNode write(AlterPartitionReassignmentsResponseData.ReassignableTopicResponse _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse _element : _object.partitions) {
                _partitionsArray.add(ReassignablePartitionResponseJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(AlterPartitionReassignmentsResponseData.ReassignableTopicResponse _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
