...
public class SyncGroupRequestDataJsonConverter {
    public static SyncGroupRequestData read(JsonNode _node, short _version) {
        ...
        if (_assignmentsNode == null) {
            ...
            ArrayList<SyncGroupRequestData.SyncGroupRequestAssignment> _collection = new ArrayList<SyncGroupRequestData.SyncGroupRequestAssignment>(_assignmentsNode.size());
    ...
    public static JsonNode write(SyncGroupRequestData _object, short _version, boolean _serializeRecords) {
        ...
        for (SyncGroupRequestData.SyncGroupRequestAssignment _element : _object.assignments) {
    ...
    public static class SyncGroupRequestAssignmentJsonConverter {
        public static SyncGroupRequestData.SyncGroupRequestAssignment read(JsonNode _node, short _version) {
            SyncGroupRequestData.SyncGroupRequestAssignment _object = new SyncGroupRequestData.SyncGroupRequestAssignment();
            JsonNode _memberIdNode = _node.get("memberId");
            if (_memberIdNode == null) {
        ...
        public static JsonNode write(SyncGroupRequestData.SyncGroupRequestAssignment _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("memberId", new TextNode(_object.memberId));
            _node.set("assignment", new BinaryNode(Arrays.copyOf(_object.assignment, _object.assignment.length)));
            return _node;
        }
        public static JsonNode write(SyncGroupRequestData.SyncGroupRequestAssignment _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
