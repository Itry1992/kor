...
import com.tong.kafka.common.feature.Features;
import com.tong.kafka.common.feature.SupportedVersionRange;
import com.tong.kafka.common.message.ApiMessageType;
import com.tong.kafka.common.message.ApiMessageType.ListenerType;
import com.tong.kafka.common.message.ApiVersionsResponseData;
import com.tong.kafka.common.message.ApiVersionsResponseData.*;
...
public class ApiVersionsResponse extends AbstractResponse {
     ...
     * @param minRecordVersion 最低支持版本
     * @param latestSupportedFeatures
     * @param finalizedFeatures
     * @param finalizedFeaturesEpoch
     * @param controllerApiVersions
     * @param listenerType
     * @return
     */
    public static ApiVersionsResponse createApiVersionsResponse(
