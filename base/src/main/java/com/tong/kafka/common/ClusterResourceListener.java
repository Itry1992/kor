...
import com.tong.kafka.clients.consumer.ConsumerInterceptor;
import com.tong.kafka.clients.consumer.ConsumerRecords;
import com.tong.kafka.clients.consumer.KafkaConsumer;
import com.tong.kafka.clients.producer.KafkaProducer;
import com.tong.kafka.clients.producer.ProducerInterceptor;
import com.tong.kafka.clients.producer.ProducerRecord;
import com.tong.kafka.clients.producer.RecordMetadata;
import com.tong.kafka.common.metrics.MetricsReporter;
 ...
 * <p>
 * {@link ConsumerInterceptor} : The {@link ClusterResourceListener#onUpdate(ClusterResource)} method will be invoked before {@link ConsumerInterceptor#onConsume(ConsumerRecords)}
 * <p>
 ...
 * and after first {@link KafkaConsumer#poll(java.time.Duration)} invocation for Consumer metrics
