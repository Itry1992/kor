...
public class DescribeTransactionsResponseDataJsonConverter {
    public static DescribeTransactionsResponseData read(JsonNode _node, short _version) {
        ...
        if (_transactionStatesNode == null) {
            ...
            ArrayList<DescribeTransactionsResponseData.TransactionState> _collection = new ArrayList<DescribeTransactionsResponseData.TransactionState>(_transactionStatesNode.size());
    ...
    public static JsonNode write(DescribeTransactionsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeTransactionsResponseData.TransactionState _element : _object.transactionStates) {
    ...
    public static class TopicDataJsonConverter {
        public static DescribeTransactionsResponseData.TopicData read(JsonNode _node, short _version) {
            DescribeTransactionsResponseData.TopicData _object = new DescribeTransactionsResponseData.TopicData();
        ...
        public static JsonNode write(DescribeTransactionsResponseData.TopicData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeTransactionsResponseData.TopicData _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class TransactionStateJsonConverter {
        public static DescribeTransactionsResponseData.TransactionState read(JsonNode _node, short _version) {
            DescribeTransactionsResponseData.TransactionState _object = new DescribeTransactionsResponseData.TransactionState();
            ...
            if (_topicsNode == null) {
                ...
                DescribeTransactionsResponseData.TopicDataCollection _collection = new DescribeTransactionsResponseData.TopicDataCollection(_topicsNode.size());
        ...
        public static JsonNode write(DescribeTransactionsResponseData.TransactionState _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (DescribeTransactionsResponseData.TopicData _element : _object.topics) {
                _topicsArray.add(TopicDataJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("topics", _topicsArray);
            return _node;
        }
        public static JsonNode write(DescribeTransactionsResponseData.TransactionState _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
