...
import com.tong.kafka.common.message.OffsetForLeaderEpochRequestData;
...
public class OffsetsForLeaderEpochRequest extends AbstractRequest {
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e) {
        ...
        data.topics().forEach(topic -> {
            OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult topicData = new OffsetForLeaderEpochResponseData.OffsetForLeaderTopicResult()
                .setTopic(topic.topic());
            topic.partitions().forEach(partition ->
                topicData.partitions().add(new OffsetForLeaderEpochResponseData.EpochEndOffset()
