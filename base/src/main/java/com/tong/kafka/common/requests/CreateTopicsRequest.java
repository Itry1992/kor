...
import com.tong.kafka.common.message.CreateTopicsRequestData;
import com.tong.kafka.common.protocol.ApiKeys;
import com.tong.kafka.common.protocol.ByteBufferAccessor;
import com.tong.kafka.common.message.CreateTopicsResponseData;
...
public class CreateTopicsRequest extends AbstractRequest {
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e) {
        ...
        for (CreateTopicsRequestData.CreatableTopic topic : data.topics()) {
