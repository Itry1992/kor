...
public class AlterUserScramCredentialsResponseDataJsonConverter {
    public static AlterUserScramCredentialsResponseData read(JsonNode _node, short _version) {
        ...
        if (_resultsNode == null) {
            ...
            ArrayList<AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult> _collection = new ArrayList<AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult>(_resultsNode.size());
    ...
    public static JsonNode write(AlterUserScramCredentialsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult _element : _object.results) {
    ...
    public static class AlterUserScramCredentialsResultJsonConverter {
        public static AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult read(JsonNode _node, short _version) {
            AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult _object = new AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult();
        ...
        public static JsonNode write(AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(AlterUserScramCredentialsResponseData.AlterUserScramCredentialsResult _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
