...
import static com.tong.kafka.common.message.DeleteRecordsResponseData.*;
...
public class DeleteRecordsResponseDataJsonConverter {
    public static DeleteRecordsResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            DeleteRecordsTopicResultCollection _collection = new DeleteRecordsTopicResultCollection(_topicsNode.size());
    ...
    public static class DeleteRecordsTopicResultJsonConverter {
        public static DeleteRecordsTopicResult read(JsonNode _node, short _version) {
            ...
            if (_partitionsNode == null) {
                ...
                DeleteRecordsPartitionResultCollection _collection = new DeleteRecordsPartitionResultCollection(_partitionsNode.size());
