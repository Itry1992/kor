...
public class OffsetDeleteResponseDataJsonConverter {
    public static OffsetDeleteResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            OffsetDeleteResponseData.OffsetDeleteResponseTopicCollection _collection = new OffsetDeleteResponseData.OffsetDeleteResponseTopicCollection(_topicsNode.size());
    ...
    public static JsonNode write(OffsetDeleteResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (OffsetDeleteResponseData.OffsetDeleteResponseTopic _element : _object.topics) {
    ...
    public static class OffsetDeleteResponsePartitionJsonConverter {
        public static OffsetDeleteResponseData.OffsetDeleteResponsePartition read(JsonNode _node, short _version) {
            OffsetDeleteResponseData.OffsetDeleteResponsePartition _object = new OffsetDeleteResponseData.OffsetDeleteResponsePartition();
        ...
        public static JsonNode write(OffsetDeleteResponseData.OffsetDeleteResponsePartition _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("partitionIndex", new IntNode(_object.partitionIndex));
            _node.set("errorCode", new ShortNode(_object.errorCode));
            return _node;
        }
        public static JsonNode write(OffsetDeleteResponseData.OffsetDeleteResponsePartition _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class OffsetDeleteResponseTopicJsonConverter {
        public static OffsetDeleteResponseData.OffsetDeleteResponseTopic read(JsonNode _node, short _version) {
            OffsetDeleteResponseData.OffsetDeleteResponseTopic _object = new OffsetDeleteResponseData.OffsetDeleteResponseTopic();
            ...
            if (_partitionsNode == null) {
                ...
                OffsetDeleteResponseData.OffsetDeleteResponsePartitionCollection _collection = new OffsetDeleteResponseData.OffsetDeleteResponsePartitionCollection(_partitionsNode.size());
        ...
        public static JsonNode write(OffsetDeleteResponseData.OffsetDeleteResponseTopic _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (OffsetDeleteResponseData.OffsetDeleteResponsePartition _element : _object.partitions) {
                _partitionsArray.add(OffsetDeleteResponsePartitionJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(OffsetDeleteResponseData.OffsetDeleteResponseTopic _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
