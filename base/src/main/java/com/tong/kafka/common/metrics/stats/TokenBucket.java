...
import com.tong.kafka.common.metrics.MeasurableStat;
import com.tong.kafka.common.metrics.MetricConfig;
import com.tong.kafka.common.metrics.Sensor;
import com.tong.kafka.common.metrics.Quota;

import java.util.concurrent.TimeUnit;

import static com.tong.kafka.common.metrics.internals.MetricsUtils.convert;

/**
 * The {@link TokenBucket} is a {@link MeasurableStat} implementing a token bucket algorithm
 * that is usable within a {@link Sensor}.
 *
 ...
 * is below zero. The enforcement is done by the {@link Sensor}.
 *
