...
public class DescribeClusterResponseDataJsonConverter {
    public static DescribeClusterResponseData read(JsonNode _node, short _version) {
        ...
        if (_brokersNode == null) {
            ...
            DescribeClusterResponseData.DescribeClusterBrokerCollection _collection = new DescribeClusterResponseData.DescribeClusterBrokerCollection(_brokersNode.size());
    ...
    public static JsonNode write(DescribeClusterResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeClusterResponseData.DescribeClusterBroker _element : _object.brokers) {
    ...
    public static class DescribeClusterBrokerJsonConverter {
        public static DescribeClusterResponseData.DescribeClusterBroker read(JsonNode _node, short _version) {
            DescribeClusterResponseData.DescribeClusterBroker _object = new DescribeClusterResponseData.DescribeClusterBroker();
        ...
        public static JsonNode write(DescribeClusterResponseData.DescribeClusterBroker _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeClusterResponseData.DescribeClusterBroker _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
