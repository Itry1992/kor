...
public class TxnOffsetCommitResponseDataJsonConverter {
    public static TxnOffsetCommitResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            ArrayList<TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic> _collection = new ArrayList<TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic>(_topicsNode.size());
    ...
    public static JsonNode write(TxnOffsetCommitResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic _element : _object.topics) {
    ...
    public static class TxnOffsetCommitResponsePartitionJsonConverter {
        public static TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition read(JsonNode _node, short _version) {
            TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition _object = new TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition();
        ...
        public static JsonNode write(TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("partitionIndex", new IntNode(_object.partitionIndex));
            _node.set("errorCode", new ShortNode(_object.errorCode));
            return _node;
        }
        public static JsonNode write(TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class TxnOffsetCommitResponseTopicJsonConverter {
        public static TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic read(JsonNode _node, short _version) {
            TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic _object = new TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition> _collection = new ArrayList<TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition>(_partitionsNode.size());
        ...
        public static JsonNode write(TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (TxnOffsetCommitResponseData.TxnOffsetCommitResponsePartition _element : _object.partitions) {
                _partitionsArray.add(TxnOffsetCommitResponsePartitionJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(TxnOffsetCommitResponseData.TxnOffsetCommitResponseTopic _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
