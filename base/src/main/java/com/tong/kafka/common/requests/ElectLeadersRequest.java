...
import com.tong.kafka.common.message.ElectLeadersRequestData;
import com.tong.kafka.common.message.ElectLeadersResponseData;
import com.tong.kafka.common.ElectionType;
...
public class ElectLeadersRequest extends AbstractRequest {
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e) {
        ...
        List<ElectLeadersResponseData.ReplicaElectionResult> electionResults = new ArrayList<>();

        if (data.topicPartitions() != null) {
            for (ElectLeadersRequestData.TopicPartitions topic : data.topicPartitions()) {
