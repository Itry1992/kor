...
public class LeaderAndIsrRequestDataJsonConverter {
    public static LeaderAndIsrRequestData read(JsonNode _node, short _version) {
        ...
        if (_ungroupedPartitionStatesNode == null) {
            if (_version <= 1) {
                ...
                _object.ungroupedPartitionStates = new ArrayList<LeaderAndIsrRequestData.LeaderAndIsrPartitionState>(0);
            }
        } else {
            ...
            ArrayList<LeaderAndIsrRequestData.LeaderAndIsrPartitionState> _collection = new ArrayList<LeaderAndIsrRequestData.LeaderAndIsrPartitionState>(_ungroupedPartitionStatesNode.size());
        ...
        if (_topicStatesNode == null) {
            if (_version >= 2) {
                ...
                _object.topicStates = new ArrayList<LeaderAndIsrRequestData.LeaderAndIsrTopicState>(0);
            }
        } else {
            if (!_topicStatesNode.isArray()) {
                throw new RuntimeException("LeaderAndIsrRequestData expected a JSON array, but got " + _node.getNodeType());
            }
            ArrayList<LeaderAndIsrRequestData.LeaderAndIsrTopicState> _collection = new ArrayList<LeaderAndIsrRequestData.LeaderAndIsrTopicState>(_topicStatesNode.size());
        ...
        if (_liveLeadersNode == null) {
            ...
            ArrayList<LeaderAndIsrRequestData.LeaderAndIsrLiveLeader> _collection = new ArrayList<LeaderAndIsrRequestData.LeaderAndIsrLiveLeader>(_liveLeadersNode.size());
    ...
    public static JsonNode write(LeaderAndIsrRequestData _object, short _version, boolean _serializeRecords) {
        ...
        if (_version <= 1) {
            ...
            for (LeaderAndIsrRequestData.LeaderAndIsrPartitionState _element : _object.ungroupedPartitionStates) {
        ...
        if (_version >= 2) {
            ...
            for (LeaderAndIsrRequestData.LeaderAndIsrTopicState _element : _object.topicStates) {
        ...
        for (LeaderAndIsrRequestData.LeaderAndIsrLiveLeader _element : _object.liveLeaders) {
    ...
    public static class LeaderAndIsrLiveLeaderJsonConverter {
        public static LeaderAndIsrRequestData.LeaderAndIsrLiveLeader read(JsonNode _node, short _version) {
            LeaderAndIsrRequestData.LeaderAndIsrLiveLeader _object = new LeaderAndIsrRequestData.LeaderAndIsrLiveLeader();
        ...
        public static JsonNode write(LeaderAndIsrRequestData.LeaderAndIsrLiveLeader _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(LeaderAndIsrRequestData.LeaderAndIsrLiveLeader _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class LeaderAndIsrPartitionStateJsonConverter {
        public static LeaderAndIsrRequestData.LeaderAndIsrPartitionState read(JsonNode _node, short _version) {
            LeaderAndIsrRequestData.LeaderAndIsrPartitionState _object = new LeaderAndIsrRequestData.LeaderAndIsrPartitionState();
            ...
            if (_partitionEpochNode == null) {
                throw new RuntimeException("LeaderAndIsrPartitionState: unable to locate field 'partitionEpoch', which is mandatory in version " + _version);
            } else {
                _object.partitionEpoch = MessageUtil.jsonNodeToInt(_partitionEpochNode, "LeaderAndIsrPartitionState");
            }
        ...
        public static JsonNode write(LeaderAndIsrRequestData.LeaderAndIsrPartitionState _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            if (_version <= 1) {
        ...
        public static JsonNode write(LeaderAndIsrRequestData.LeaderAndIsrPartitionState _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class LeaderAndIsrTopicStateJsonConverter {
        public static LeaderAndIsrRequestData.LeaderAndIsrTopicState read(JsonNode _node, short _version) {
            LeaderAndIsrRequestData.LeaderAndIsrTopicState _object = new LeaderAndIsrRequestData.LeaderAndIsrTopicState();
            if (_version < 2) {
            ...
            if (_partitionStatesNode == null) {
                ...
                ArrayList<LeaderAndIsrRequestData.LeaderAndIsrPartitionState> _collection = new ArrayList<LeaderAndIsrRequestData.LeaderAndIsrPartitionState>(_partitionStatesNode.size());
        ...
        public static JsonNode write(LeaderAndIsrRequestData.LeaderAndIsrTopicState _object, short _version, boolean _serializeRecords) {
            if (_version < 2) {
            ...
            for (LeaderAndIsrRequestData.LeaderAndIsrPartitionState _element : _object.partitionStates) {
        ...
        public static JsonNode write(LeaderAndIsrRequestData.LeaderAndIsrTopicState _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
