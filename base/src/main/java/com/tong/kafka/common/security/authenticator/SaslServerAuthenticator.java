...
import com.tong.kafka.common.message.SaslHandshakeResponseData;
...
import com.tong.kafka.common.message.SaslAuthenticateResponseData;
        ...
        if (mechanism.equals(SaslConfigs.GSSAPI_MECHANISM)) {
            ...
            try {
                saslServer = Subject.doAs(subject, (PrivilegedExceptionAction<SaslServer>) () ->
                    Sasl.createSaslServer(saslMechanism, "com/tong/kafka", serverAddress().getHostName(), configs, callbackHandler));
                if (saslServer == null) {
