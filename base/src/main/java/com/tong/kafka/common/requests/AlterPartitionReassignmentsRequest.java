...
import com.tong.kafka.common.message.AlterPartitionReassignmentsRequestData;
import com.tong.kafka.common.message.AlterPartitionReassignmentsResponseData;
...
public class AlterPartitionReassignmentsRequest extends AbstractRequest {
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e) {
        ...
        List<AlterPartitionReassignmentsResponseData.ReassignableTopicResponse> topicResponses = new ArrayList<>();

        for (AlterPartitionReassignmentsRequestData.ReassignableTopic topic : data.topics()) {
            List<AlterPartitionReassignmentsResponseData.ReassignablePartitionResponse> partitionResponses = topic.partitions().stream().map(partition ->
