...
public class DescribeLogDirsResponseDataJsonConverter {
    public static DescribeLogDirsResponseData read(JsonNode _node, short _version) {
        ...
        if (_resultsNode == null) {
            ...
            ArrayList<DescribeLogDirsResponseData.DescribeLogDirsResult> _collection = new ArrayList<DescribeLogDirsResponseData.DescribeLogDirsResult>(_resultsNode.size());
    ...
    public static JsonNode write(DescribeLogDirsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeLogDirsResponseData.DescribeLogDirsResult _element : _object.results) {
    ...
    public static class DescribeLogDirsPartitionJsonConverter {
        public static DescribeLogDirsResponseData.DescribeLogDirsPartition read(JsonNode _node, short _version) {
            DescribeLogDirsResponseData.DescribeLogDirsPartition _object = new DescribeLogDirsResponseData.DescribeLogDirsPartition();
        ...
        public static JsonNode write(DescribeLogDirsResponseData.DescribeLogDirsPartition _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeLogDirsResponseData.DescribeLogDirsPartition _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class DescribeLogDirsResultJsonConverter {
        public static DescribeLogDirsResponseData.DescribeLogDirsResult read(JsonNode _node, short _version) {
            DescribeLogDirsResponseData.DescribeLogDirsResult _object = new DescribeLogDirsResponseData.DescribeLogDirsResult();
            JsonNode _errorCodeNode = _node.get("errorCode");
            if (_errorCodeNode == null) {
            ...
            if (_topicsNode == null) {
                ...
                ArrayList<DescribeLogDirsResponseData.DescribeLogDirsTopic> _collection = new ArrayList<DescribeLogDirsResponseData.DescribeLogDirsTopic>(_topicsNode.size());
        ...
        public static JsonNode write(DescribeLogDirsResponseData.DescribeLogDirsResult _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("errorCode", new ShortNode(_object.errorCode));
            _node.set("logDir", new TextNode(_object.logDir));
            ArrayNode _topicsArray = new ArrayNode(JsonNodeFactory.instance);
            for (DescribeLogDirsResponseData.DescribeLogDirsTopic _element : _object.topics) {
        ...
        public static JsonNode write(DescribeLogDirsResponseData.DescribeLogDirsResult _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class DescribeLogDirsTopicJsonConverter {
        public static DescribeLogDirsResponseData.DescribeLogDirsTopic read(JsonNode _node, short _version) {
            DescribeLogDirsResponseData.DescribeLogDirsTopic _object = new DescribeLogDirsResponseData.DescribeLogDirsTopic();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<DescribeLogDirsResponseData.DescribeLogDirsPartition> _collection = new ArrayList<DescribeLogDirsResponseData.DescribeLogDirsPartition>(_partitionsNode.size());
        ...
        public static JsonNode write(DescribeLogDirsResponseData.DescribeLogDirsTopic _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (DescribeLogDirsResponseData.DescribeLogDirsPartition _element : _object.partitions) {
                _partitionsArray.add(DescribeLogDirsPartitionJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(DescribeLogDirsResponseData.DescribeLogDirsTopic _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
