...
public class BrokerRegistrationRequestDataJsonConverter {
    public static BrokerRegistrationRequestData read(JsonNode _node, short _version) {
        ...
        if (_listenersNode == null) {
            ...
            BrokerRegistrationRequestData.ListenerCollection _collection = new BrokerRegistrationRequestData.ListenerCollection(_listenersNode.size());
        ...
        if (_featuresNode == null) {
            ...
            BrokerRegistrationRequestData.FeatureCollection _collection = new BrokerRegistrationRequestData.FeatureCollection(_featuresNode.size());
    ...
    public static JsonNode write(BrokerRegistrationRequestData _object, short _version, boolean _serializeRecords) {
        ...
        for (BrokerRegistrationRequestData.Listener _element : _object.listeners) {
        ...
        for (BrokerRegistrationRequestData.Feature _element : _object.features) {
    ...
    public static class FeatureJsonConverter {
        public static BrokerRegistrationRequestData.Feature read(JsonNode _node, short _version) {
            BrokerRegistrationRequestData.Feature _object = new BrokerRegistrationRequestData.Feature();
        ...
        public static JsonNode write(BrokerRegistrationRequestData.Feature _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(BrokerRegistrationRequestData.Feature _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class ListenerJsonConverter {
        public static BrokerRegistrationRequestData.Listener read(JsonNode _node, short _version) {
            BrokerRegistrationRequestData.Listener _object = new BrokerRegistrationRequestData.Listener();
            JsonNode _nameNode = _node.get("name");
            if (_nameNode == null) {
        ...
        public static JsonNode write(BrokerRegistrationRequestData.Listener _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
        ...
        public static JsonNode write(BrokerRegistrationRequestData.Listener _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
