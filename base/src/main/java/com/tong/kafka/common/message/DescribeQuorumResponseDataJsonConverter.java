...
public class DescribeQuorumResponseDataJsonConverter {
    public static DescribeQuorumResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            ArrayList<DescribeQuorumResponseData.TopicData> _collection = new ArrayList<DescribeQuorumResponseData.TopicData>(_topicsNode.size());
    ...
    public static JsonNode write(DescribeQuorumResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeQuorumResponseData.TopicData _element : _object.topics) {
    ...
    public static class PartitionDataJsonConverter {
        public static DescribeQuorumResponseData.PartitionData read(JsonNode _node, short _version) {
            DescribeQuorumResponseData.PartitionData _object = new DescribeQuorumResponseData.PartitionData();
            ...
            if (_currentVotersNode == null) {
                ...
                ArrayList<DescribeQuorumResponseData.ReplicaState> _collection = new ArrayList<DescribeQuorumResponseData.ReplicaState>(_currentVotersNode.size());
            ...
            if (_observersNode == null) {
                ...
                ArrayList<DescribeQuorumResponseData.ReplicaState> _collection = new ArrayList<DescribeQuorumResponseData.ReplicaState>(_observersNode.size());
        ...
        public static JsonNode write(DescribeQuorumResponseData.PartitionData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (DescribeQuorumResponseData.ReplicaState _element : _object.currentVoters) {
            ...
            for (DescribeQuorumResponseData.ReplicaState _element : _object.observers) {
        ...
        public static JsonNode write(DescribeQuorumResponseData.PartitionData _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class ReplicaStateJsonConverter {
        public static DescribeQuorumResponseData.ReplicaState read(JsonNode _node, short _version) {
            DescribeQuorumResponseData.ReplicaState _object = new DescribeQuorumResponseData.ReplicaState();
        ...
        public static JsonNode write(DescribeQuorumResponseData.ReplicaState _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeQuorumResponseData.ReplicaState _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class TopicDataJsonConverter {
        public static DescribeQuorumResponseData.TopicData read(JsonNode _node, short _version) {
            DescribeQuorumResponseData.TopicData _object = new DescribeQuorumResponseData.TopicData();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<DescribeQuorumResponseData.PartitionData> _collection = new ArrayList<DescribeQuorumResponseData.PartitionData>(_partitionsNode.size());
        ...
        public static JsonNode write(DescribeQuorumResponseData.TopicData _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("topicName", new TextNode(_object.topicName));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (DescribeQuorumResponseData.PartitionData _element : _object.partitions) {
                _partitionsArray.add(PartitionDataJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(DescribeQuorumResponseData.TopicData _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
