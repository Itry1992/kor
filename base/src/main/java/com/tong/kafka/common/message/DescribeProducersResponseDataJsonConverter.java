...
public class DescribeProducersResponseDataJsonConverter {
    public static DescribeProducersResponseData read(JsonNode _node, short _version) {
        ...
        if (_topicsNode == null) {
            ...
            ArrayList<DescribeProducersResponseData.TopicResponse> _collection = new ArrayList<DescribeProducersResponseData.TopicResponse>(_topicsNode.size());
    ...
    public static JsonNode write(DescribeProducersResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeProducersResponseData.TopicResponse _element : _object.topics) {
    ...
    public static class PartitionResponseJsonConverter {
        public static DescribeProducersResponseData.PartitionResponse read(JsonNode _node, short _version) {
            DescribeProducersResponseData.PartitionResponse _object = new DescribeProducersResponseData.PartitionResponse();
            ...
            if (_activeProducersNode == null) {
                ...
                ArrayList<DescribeProducersResponseData.ProducerState> _collection = new ArrayList<DescribeProducersResponseData.ProducerState>(_activeProducersNode.size());
        ...
        public static JsonNode write(DescribeProducersResponseData.PartitionResponse _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (DescribeProducersResponseData.ProducerState _element : _object.activeProducers) {
        ...
        public static JsonNode write(DescribeProducersResponseData.PartitionResponse _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class ProducerStateJsonConverter {
        public static DescribeProducersResponseData.ProducerState read(JsonNode _node, short _version) {
            DescribeProducersResponseData.ProducerState _object = new DescribeProducersResponseData.ProducerState();
        ...
        public static JsonNode write(DescribeProducersResponseData.ProducerState _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeProducersResponseData.ProducerState _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class TopicResponseJsonConverter {
        public static DescribeProducersResponseData.TopicResponse read(JsonNode _node, short _version) {
            DescribeProducersResponseData.TopicResponse _object = new DescribeProducersResponseData.TopicResponse();
            ...
            if (_partitionsNode == null) {
                ...
                ArrayList<DescribeProducersResponseData.PartitionResponse> _collection = new ArrayList<DescribeProducersResponseData.PartitionResponse>(_partitionsNode.size());
        ...
        public static JsonNode write(DescribeProducersResponseData.TopicResponse _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            ArrayNode _partitionsArray = new ArrayNode(JsonNodeFactory.instance);
            for (DescribeProducersResponseData.PartitionResponse _element : _object.partitions) {
                _partitionsArray.add(PartitionResponseJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("partitions", _partitionsArray);
            return _node;
        }
        public static JsonNode write(DescribeProducersResponseData.TopicResponse _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
