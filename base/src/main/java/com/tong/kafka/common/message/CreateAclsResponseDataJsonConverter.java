...
public class CreateAclsResponseDataJsonConverter {
    public static CreateAclsResponseData read(JsonNode _node, short _version) {
        ...
        if (_resultsNode == null) {
            ...
            ArrayList<CreateAclsResponseData.AclCreationResult> _collection = new ArrayList<CreateAclsResponseData.AclCreationResult>(_resultsNode.size());
    ...
    public static JsonNode write(CreateAclsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (CreateAclsResponseData.AclCreationResult _element : _object.results) {
    ...
    public static class AclCreationResultJsonConverter {
        public static CreateAclsResponseData.AclCreationResult read(JsonNode _node, short _version) {
            CreateAclsResponseData.AclCreationResult _object = new CreateAclsResponseData.AclCreationResult();
        ...
        public static JsonNode write(CreateAclsResponseData.AclCreationResult _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(CreateAclsResponseData.AclCreationResult _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
