 ...
 */
package com.tong.kafka.common.metrics.stats;

import com.tong.kafka.common.metrics.Measurable;
import com.tong.kafka.common.metrics.MetricConfig;
import com.tong.kafka.common.metrics.Sensor;
import com.tong.kafka.common.MetricName;
import com.tong.kafka.common.metrics.CompoundStat;
import com.tong.kafka.common.metrics.stats.Histogram.BinScheme;
import com.tong.kafka.common.metrics.stats.Histogram.ConstantBinScheme;
 ...
 * that succeeded.
 * <p>
 * This can be accomplish by created a {@link Sensor Sensor} to record the values,
 ...
 * object is a {@link CompoundStat}, and so it can be {@link Sensor#add(CompoundStat)
