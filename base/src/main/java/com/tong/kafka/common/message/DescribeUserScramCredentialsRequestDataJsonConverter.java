...
public class DescribeUserScramCredentialsRequestDataJsonConverter {
    public static DescribeUserScramCredentialsRequestData read(JsonNode _node, short _version) {
        ...
        if (_usersNode == null) {
            ...
            if (_usersNode.isNull()) {
                ...
                ArrayList<DescribeUserScramCredentialsRequestData.UserName> _collection = new ArrayList<DescribeUserScramCredentialsRequestData.UserName>(_usersNode.size());
    ...
    public static JsonNode write(DescribeUserScramCredentialsRequestData _object, short _version, boolean _serializeRecords) {
        ...
        if (_object.users == null) {
            ...
            for (DescribeUserScramCredentialsRequestData.UserName _element : _object.users) {
    ...
    public static class UserNameJsonConverter {
        public static DescribeUserScramCredentialsRequestData.UserName read(JsonNode _node, short _version) {
            DescribeUserScramCredentialsRequestData.UserName _object = new DescribeUserScramCredentialsRequestData.UserName();
        ...
        public static JsonNode write(DescribeUserScramCredentialsRequestData.UserName _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
            return _node;
        }
        public static JsonNode write(DescribeUserScramCredentialsRequestData.UserName _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
