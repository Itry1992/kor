...
public class WriteTxnMarkersRequestDataJsonConverter {
    public static WriteTxnMarkersRequestData read(JsonNode _node, short _version) {
        ...
        if (_markersNode == null) {
            ...
            ArrayList<WriteTxnMarkersRequestData.WritableTxnMarker> _collection = new ArrayList<WriteTxnMarkersRequestData.WritableTxnMarker>(_markersNode.size());
    ...
    public static JsonNode write(WriteTxnMarkersRequestData _object, short _version, boolean _serializeRecords) {
        ...
        for (WriteTxnMarkersRequestData.WritableTxnMarker _element : _object.markers) {
    ...
    public static class WritableTxnMarkerJsonConverter {
        public static WriteTxnMarkersRequestData.WritableTxnMarker read(JsonNode _node, short _version) {
            WriteTxnMarkersRequestData.WritableTxnMarker _object = new WriteTxnMarkersRequestData.WritableTxnMarker();
            ...
            if (_topicsNode == null) {
                ...
                ArrayList<WriteTxnMarkersRequestData.WritableTxnMarkerTopic> _collection = new ArrayList<WriteTxnMarkersRequestData.WritableTxnMarkerTopic>(_topicsNode.size());
        ...
        public static JsonNode write(WriteTxnMarkersRequestData.WritableTxnMarker _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (WriteTxnMarkersRequestData.WritableTxnMarkerTopic _element : _object.topics) {
        ...
        public static JsonNode write(WriteTxnMarkersRequestData.WritableTxnMarker _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class WritableTxnMarkerTopicJsonConverter {
        public static WriteTxnMarkersRequestData.WritableTxnMarkerTopic read(JsonNode _node, short _version) {
            WriteTxnMarkersRequestData.WritableTxnMarkerTopic _object = new WriteTxnMarkersRequestData.WritableTxnMarkerTopic();
        ...
        public static JsonNode write(WriteTxnMarkersRequestData.WritableTxnMarkerTopic _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(WriteTxnMarkersRequestData.WritableTxnMarkerTopic _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
