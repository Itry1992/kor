...
import com.tong.kafka.clients.admin.AlterConfigOp;
import com.tong.kafka.common.message.IncrementalAlterConfigsResponseData;
...
import com.tong.kafka.common.message.IncrementalAlterConfigsRequestData;
import com.tong.kafka.common.message.IncrementalAlterConfigsRequestData.AlterConfigsResource;
...
public class IncrementalAlterConfigsRequest extends AbstractRequest {
    ...
    public AbstractResponse getErrorResponse(final int throttleTimeMs, final Throwable e) {
        ...
        for (AlterConfigsResource resource : data.resources()) {
            response.responses().add(new IncrementalAlterConfigsResponseData.AlterConfigsResourceResponse()
