...
import com.tong.kafka.common.message.DescribeClientQuotasRequestData;
import com.tong.kafka.common.protocol.ByteBufferAccessor;
import com.tong.kafka.common.message.DescribeClientQuotasResponseData;
import com.tong.kafka.common.protocol.ApiKeys;
import com.tong.kafka.common.quota.ClientQuotaFilter;
import com.tong.kafka.common.quota.ClientQuotaFilterComponent;
...
public class DescribeClientQuotasRequest extends AbstractRequest {
    ...
    public static class Builder extends AbstractRequest.Builder<DescribeClientQuotasRequest> {
        ...
        public Builder(ClientQuotaFilter filter) {
            ...
            List<DescribeClientQuotasRequestData.ComponentData> componentData = new ArrayList<>(filter.components().size());
    ...
    public ClientQuotaFilter filter() {
        ...
        for (DescribeClientQuotasRequestData.ComponentData componentData : data.components()) {
