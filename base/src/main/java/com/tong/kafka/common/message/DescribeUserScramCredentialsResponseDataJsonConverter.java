...
public class DescribeUserScramCredentialsResponseDataJsonConverter {
    public static DescribeUserScramCredentialsResponseData read(JsonNode _node, short _version) {
        ...
        if (_resultsNode == null) {
            ...
            ArrayList<DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult> _collection = new ArrayList<DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult>(_resultsNode.size());
    ...
    public static JsonNode write(DescribeUserScramCredentialsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult _element : _object.results) {
    ...
    public static class CredentialInfoJsonConverter {
        public static DescribeUserScramCredentialsResponseData.CredentialInfo read(JsonNode _node, short _version) {
            DescribeUserScramCredentialsResponseData.CredentialInfo _object = new DescribeUserScramCredentialsResponseData.CredentialInfo();
        ...
        public static JsonNode write(DescribeUserScramCredentialsResponseData.CredentialInfo _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("mechanism", new ShortNode(_object.mechanism));
            _node.set("iterations", new IntNode(_object.iterations));
            return _node;
        }
        public static JsonNode write(DescribeUserScramCredentialsResponseData.CredentialInfo _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class DescribeUserScramCredentialsResultJsonConverter {
        public static DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult read(JsonNode _node, short _version) {
            DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult _object = new DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult();
            ...
            if (_credentialInfosNode == null) {
                ...
                ArrayList<DescribeUserScramCredentialsResponseData.CredentialInfo> _collection = new ArrayList<DescribeUserScramCredentialsResponseData.CredentialInfo>(_credentialInfosNode.size());
        ...
        public static JsonNode write(DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (DescribeUserScramCredentialsResponseData.CredentialInfo _element : _object.credentialInfos) {
        ...
        public static JsonNode write(DescribeUserScramCredentialsResponseData.DescribeUserScramCredentialsResult _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
