...
import com.tong.kafka.common.message.DescribeConfigsResponseData;
...
public class DescribeConfigsResponse extends AbstractResponse {
    ...
    public enum ConfigSource {
        UNKNOWN((byte) 0, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource.UNKNOWN),
        TOPIC_CONFIG((byte) 1, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource.DYNAMIC_TOPIC_CONFIG),
        DYNAMIC_BROKER_CONFIG((byte) 2, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource.DYNAMIC_BROKER_CONFIG),
        DYNAMIC_DEFAULT_BROKER_CONFIG((byte) 3, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource.DYNAMIC_DEFAULT_BROKER_CONFIG),
        STATIC_BROKER_CONFIG((byte) 4, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource.STATIC_BROKER_CONFIG),
        DEFAULT_CONFIG((byte) 5, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource.DEFAULT_CONFIG),
        DYNAMIC_BROKER_LOGGER_CONFIG((byte) 6, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource.DYNAMIC_BROKER_LOGGER_CONFIG);

        final byte id;
        private final com.tong.kafka.clients.admin.ConfigEntry.ConfigSource source;
        private static final ConfigSource[] VALUES = values();

        ConfigSource(byte id, com.tong.kafka.clients.admin.ConfigEntry.ConfigSource source) {
            this.id = id;
            this.source = source;
        }
        ...
        public com.tong.kafka.clients.admin.ConfigEntry.ConfigSource source() {
            return source;
        }
    }

    public enum ConfigType {
        UNKNOWN((byte) 0, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.UNKNOWN),
        BOOLEAN((byte) 1, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.BOOLEAN),
        STRING((byte) 2, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.STRING),
        INT((byte) 3, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.INT),
        SHORT((byte) 4, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.SHORT),
        LONG((byte) 5, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.LONG),
        DOUBLE((byte) 6, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.DOUBLE),
        LIST((byte) 7, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.LIST),
        CLASS((byte) 8, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.CLASS),
        PASSWORD((byte) 9, com.tong.kafka.clients.admin.ConfigEntry.ConfigType.PASSWORD);

        final byte id;
        final com.tong.kafka.clients.admin.ConfigEntry.ConfigType type;
        private static final ConfigType[] VALUES = values();

        ConfigType(byte id, com.tong.kafka.clients.admin.ConfigEntry.ConfigType type) {
            this.id = id;
            this.type = type;
        }
        ...
        public com.tong.kafka.clients.admin.ConfigEntry.ConfigType type() {
            return type;
        }
    }
