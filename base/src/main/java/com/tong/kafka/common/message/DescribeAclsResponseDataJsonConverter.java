...
public class DescribeAclsResponseDataJsonConverter {
    public static DescribeAclsResponseData read(JsonNode _node, short _version) {
        ...
        if (_resourcesNode == null) {
            ...
            ArrayList<DescribeAclsResponseData.DescribeAclsResource> _collection = new ArrayList<DescribeAclsResponseData.DescribeAclsResource>(_resourcesNode.size());
    ...
    public static JsonNode write(DescribeAclsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeAclsResponseData.DescribeAclsResource _element : _object.resources) {
    ...
    public static class AclDescriptionJsonConverter {
        public static DescribeAclsResponseData.AclDescription read(JsonNode _node, short _version) {
            DescribeAclsResponseData.AclDescription _object = new DescribeAclsResponseData.AclDescription();
        ...
        public static JsonNode write(DescribeAclsResponseData.AclDescription _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(DescribeAclsResponseData.AclDescription _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class DescribeAclsResourceJsonConverter {
        public static DescribeAclsResponseData.DescribeAclsResource read(JsonNode _node, short _version) {
            DescribeAclsResponseData.DescribeAclsResource _object = new DescribeAclsResponseData.DescribeAclsResource();
            ...
            if (_aclsNode == null) {
                ...
                ArrayList<DescribeAclsResponseData.AclDescription> _collection = new ArrayList<DescribeAclsResponseData.AclDescription>(_aclsNode.size());
        ...
        public static JsonNode write(DescribeAclsResponseData.DescribeAclsResource _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (DescribeAclsResponseData.AclDescription _element : _object.acls) {
                _aclsArray.add(AclDescriptionJsonConverter.write(_element, _version, _serializeRecords));
            }
            _node.set("acls", _aclsArray);
            return _node;
        }
        public static JsonNode write(DescribeAclsResponseData.DescribeAclsResource _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
