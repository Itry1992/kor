...
public class ListTransactionsResponseDataJsonConverter {
    public static ListTransactionsResponseData read(JsonNode _node, short _version) {
        ...
        if (_transactionStatesNode == null) {
            ...
            ArrayList<ListTransactionsResponseData.TransactionState> _collection = new ArrayList<ListTransactionsResponseData.TransactionState>(_transactionStatesNode.size());
    ...
    public static JsonNode write(ListTransactionsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (ListTransactionsResponseData.TransactionState _element : _object.transactionStates) {
    ...
    public static class TransactionStateJsonConverter {
        public static ListTransactionsResponseData.TransactionState read(JsonNode _node, short _version) {
            ListTransactionsResponseData.TransactionState _object = new ListTransactionsResponseData.TransactionState();
        ...
        public static JsonNode write(ListTransactionsResponseData.TransactionState _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
        ...
        public static JsonNode write(ListTransactionsResponseData.TransactionState _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
