...
import com.tong.kafka.common.security.oauthbearer.internals.unsecured.OAuthBearerIllegalTokenException;
import com.tong.kafka.common.security.oauthbearer.internals.unsecured.OAuthBearerUnsecuredJws;
...
public class LoginAccessTokenValidator implements AccessTokenValidator {
    ...
    public LoginAccessTokenValidator(String scopeClaimName, String subClaimName) {
        this.scopeClaimName = ClaimValidationUtils.validateClaimNameOverride(SaslConfigs.DEFAULT_SASL_OAUTHBEARER_SCOPE_CLAIM_NAME, scopeClaimName);
        this.subClaimName = ClaimValidationUtils.validateClaimNameOverride(SaslConfigs.DEFAULT_SASL_OAUTHBEARER_SUB_CLAIM_NAME, subClaimName);
    }
