...
public class DescribeDelegationTokenResponseDataJsonConverter {
    public static DescribeDelegationTokenResponseData read(JsonNode _node, short _version) {
        ...
        if (_tokensNode == null) {
            ...
            ArrayList<DescribeDelegationTokenResponseData.DescribedDelegationToken> _collection = new ArrayList<DescribeDelegationTokenResponseData.DescribedDelegationToken>(_tokensNode.size());
    ...
    public static JsonNode write(DescribeDelegationTokenResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (DescribeDelegationTokenResponseData.DescribedDelegationToken _element : _object.tokens) {
    ...
    public static class DescribedDelegationTokenJsonConverter {
        public static DescribeDelegationTokenResponseData.DescribedDelegationToken read(JsonNode _node, short _version) {
            DescribeDelegationTokenResponseData.DescribedDelegationToken _object = new DescribeDelegationTokenResponseData.DescribedDelegationToken();
            ...
            if (_tokenRequesterPrincipalTypeNode == null) {
                if (_version >= 3) {
                    throw new RuntimeException("DescribedDelegationToken: unable to locate field 'tokenRequesterPrincipalType', which is mandatory in version " + _version);
                } else {
            ...
            if (_tokenRequesterPrincipalNameNode == null) {
                if (_version >= 3) {
                    throw new RuntimeException("DescribedDelegationToken: unable to locate field 'tokenRequesterPrincipalName', which is mandatory in version " + _version);
                } else {
            ...
            if (_renewersNode == null) {
                ...
                ArrayList<DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer> _collection = new ArrayList<DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer>(_renewersNode.size());
        ...
        public static JsonNode write(DescribeDelegationTokenResponseData.DescribedDelegationToken _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            ...
            for (DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer _element : _object.renewers) {
        ...
        public static JsonNode write(DescribeDelegationTokenResponseData.DescribedDelegationToken _object, short _version) {
            return write(_object, _version, true);
        }
    }
    
    public static class DescribedDelegationTokenRenewerJsonConverter {
        public static DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer read(JsonNode _node, short _version) {
            DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer _object = new DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer();
            JsonNode _principalTypeNode = _node.get("principalType");
            if (_principalTypeNode == null) {
        ...
        public static JsonNode write(DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("principalType", new TextNode(_object.principalType));
            _node.set("principalName", new TextNode(_object.principalName));
            return _node;
        }
        public static JsonNode write(DescribeDelegationTokenResponseData.DescribedDelegationTokenRenewer _object, short _version) {
            return write(_object, _version, true);
        }
    }
}
