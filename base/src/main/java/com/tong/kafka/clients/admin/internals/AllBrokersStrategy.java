...
import com.tong.kafka.clients.admin.ListTransactionsResult;
import com.tong.kafka.common.message.MetadataResponseData;
import com.tong.kafka.common.requests.MetadataResponse;
import com.tong.kafka.common.internals.KafkaFutureImpl;
import com.tong.kafka.common.message.MetadataRequestData;
 ...
 * For example, see {@link ListTransactionsResult}.
 */
public class AllBrokersStrategy implements AdminApiLookupStrategy<AllBrokersStrategy.BrokerKey> {
    ...
    public static class AllBrokersFuture<V> implements AdminApiFuture<BrokerKey, V> {
        ...
        private void completeExceptionally(BrokerKey key, Throwable t) {
            if (key == ANY_BROKER) {
