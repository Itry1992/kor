...
import com.tong.kafka.common.requests.FindCoordinatorRequest;
import com.tong.kafka.common.requests.OffsetCommitResponse;
import com.tong.kafka.common.requests.OffsetCommitRequest;
...
public class AlterConsumerGroupOffsetsHandler extends AdminApiHandler.Batched<CoordinatorKey, Map<TopicPartition, Errors>> {
    ...
    public OffsetCommitRequest.Builder buildBatchedRequest(
        ...
        Map<String, OffsetCommitRequestData.OffsetCommitRequestTopic> offsetData = new HashMap<>();
        offsets.forEach((topicPartition, offsetAndMetadata) -> {
            OffsetCommitRequestData.OffsetCommitRequestTopic topic = offsetData.computeIfAbsent(
                topicPartition.topic(),
                key -> new OffsetCommitRequestData.OffsetCommitRequestTopic().setName(topicPartition.topic())
            );
