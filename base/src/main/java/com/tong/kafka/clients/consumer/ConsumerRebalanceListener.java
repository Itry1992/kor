 ...
 * consumption.
 * <p>
 * This callback will only execute in the user thread as part of the {@link Consumer#poll(Duration) poll(long)} call
 ...
 * invocation of {@link KafkaConsumer#poll(Duration)} as well.
 * <p>
 ...
 * as it will be propagated all the way up to the {@link KafkaConsumer#poll(Duration)} call.
