...
public interface ConsumerPartitionAssignor {
     ...
     *
     * @param topics Topics subscribed to through {@link KafkaConsumer#subscribe(java.util.Collection)}
     *               and variants
    ...
    /**
     * Get a list of configured instances of {@link ConsumerPartitionAssignor}
     * based on the class names/types specified by {@link ConsumerConfig#PARTITION_ASSIGNMENT_STRATEGY_CONFIG}
     */
