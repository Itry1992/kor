...
import com.tong.kafka.clients.ClientResponse;
...
import com.tong.kafka.common.message.FindCoordinatorResponseData.Coordinator;
...
public abstract class AbstractCoordinator implements Closeable {
     ...
     */
    protected abstract boolean onJoinPrepare(com.tong.kafka.common.utils.Timer timer, int generation, String memberId);
     ...
     */
    protected synchronized boolean ensureCoordinatorReady(final com.tong.kafka.common.utils.Timer timer) {
     ...
     * @throws KafkaException if the callback throws exception
     */
    boolean joinGroupIfNeeded(final com.tong.kafka.common.utils.Timer timer) {
        ...
        try {
            ...
            for (Map.Entry<String, ByteBuffer> assignment : groupAssignment.entrySet()) {
                groupAssignmentList.add(new SyncGroupRequestData.SyncGroupRequestAssignment()
                        ...
                        .setAssignment(com.tong.kafka.common.utils.Utils.toArray(assignment.getValue()))
                );
            }
    ...
    private class LeaveGroupResponseHandler extends CoordinatorResponseHandler<LeaveGroupResponse, Void> {
        ...
        public void handle(LeaveGroupResponse leaveResponse, RequestFuture<Void> future) {
            final List<LeaveGroupResponseData.MemberResponse> members = leaveResponse.memberResponses();
            if (members.size() > 1) {
