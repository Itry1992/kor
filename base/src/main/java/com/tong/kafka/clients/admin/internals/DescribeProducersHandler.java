 ...
 */
package com.tong.kafka.clients.admin.internals;

import com.tong.kafka.clients.admin.DescribeProducersOptions;
import com.tong.kafka.clients.admin.DescribeProducersResult;
import com.tong.kafka.clients.admin.ProducerState;
import com.tong.kafka.common.Node;
import com.tong.kafka.common.TopicPartition;
import com.tong.kafka.common.errors.InvalidTopicException;
import com.tong.kafka.common.errors.TopicAuthorizationException;
import com.tong.kafka.common.message.DescribeProducersRequestData;
import com.tong.kafka.common.message.DescribeProducersResponseData;
import com.tong.kafka.common.protocol.Errors;
import com.tong.kafka.common.requests.AbstractResponse;
import com.tong.kafka.common.requests.DescribeProducersResponse;
import com.tong.kafka.common.utils.CollectionUtils;
import com.tong.kafka.common.requests.ApiError;
import com.tong.kafka.common.requests.DescribeProducersRequest;
...
public class DescribeProducersHandler extends AdminApiHandler.Batched<TopicPartition, DescribeProducersResult.PartitionProducerState> {
    ...
    public static AdminApiFuture.SimpleAdminApiFuture<TopicPartition, DescribeProducersResult.PartitionProducerState> newFuture(
    ...
    @Override
    public ApiResult<TopicPartition, DescribeProducersResult.PartitionProducerState> handleResponse(
        Node broker,
        Set<TopicPartition> keys,
        AbstractResponse abstractResponse
    ) {
        DescribeProducersResponse response = (DescribeProducersResponse) abstractResponse;
        Map<TopicPartition, DescribeProducersResult.PartitionProducerState> completed = new HashMap<>();
