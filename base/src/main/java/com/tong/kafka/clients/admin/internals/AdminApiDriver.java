...
import com.tong.kafka.clients.admin.KafkaAdminClient;
...
import com.tong.kafka.common.errors.DisconnectException;
import com.tong.kafka.common.requests.OffsetFetchRequest.NoBatchedOffsetFetchRequestException;
...
public class AdminApiDriver<K, V> {
    ...
    public void onFailure(
        ...
        } else if (t instanceof FindCoordinatorRequest.NoBatchedFindCoordinatorsException || t instanceof NoBatchedOffsetFetchRequestException) {
