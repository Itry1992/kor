 ...
 */
package com.tong.kafka.clients.producer;

import com.tong.kafka.clients.*;
import com.tong.kafka.clients.consumer.CommitFailedException;
import com.tong.kafka.clients.producer.internals.*;
...
import com.tong.kafka.common.header.internals.RecordHeaders;
import com.tong.kafka.common.metrics.*;
import com.tong.kafka.common.network.Selector;
import com.tong.kafka.common.record.AbstractRecords;
import com.tong.kafka.common.record.CompressionType;
import com.tong.kafka.common.record.TimestampType;
import com.tong.kafka.common.serialization.ByteArraySerializer;
import com.tong.kafka.common.serialization.StringSerializer;
import com.tong.kafka.common.utils.*;

import com.tong.kafka.clients.consumer.ConsumerGroupMetadata;
import com.tong.kafka.clients.consumer.KafkaConsumer;
import com.tong.kafka.clients.consumer.OffsetAndMetadata;
import com.tong.kafka.clients.consumer.OffsetCommitCallback;



import com.tong.kafka.common.header.Headers;
import com.tong.kafka.common.internals.ClusterResourceListeners;

import com.tong.kafka.common.network.ChannelBuilder;
import com.tong.kafka.common.record.RecordBatch;
import com.tong.kafka.common.requests.JoinGroupRequest;
import com.tong.kafka.common.serialization.Serializer;
...
public class KafkaProducer<K, V> implements Producer<K, V> {
     ...
     * @throws InvalidProducerEpochException if the producer has attempted to produce with an old epoch
     ...
     * @throws UnsupportedVersionException fatal error indicating the broker
     *         does not support transactions (i.e. if its version is lower than 0.11.0.0)
     * @throws UnsupportedForMessageFormatException fatal error indicating the message
     ...
     * @throws FencedInstanceIdException if this producer instance gets fenced by broker due to a
     ...
     * If {@link TimestampType#CREATE_TIME CreateTime} is used by the topic, the timestamp
     ...
     * if a transactional send finishes with a {@link ProducerFencedException}, a {@link OutOfOrderSequenceException},
     * a {@link UnsupportedVersionException}, or an
     ...
     * In this case, {@link UnsupportedVersionException} and
     ...
     * sending after receiving an {@link OutOfOrderSequenceException}, but doing so
     ...
     * produce requests will fail with an {@link UnsupportedForMessageFormatException}
    ...
    private Future<RecordMetadata> doSend(ProducerRecord<K, V> record, Callback callback) {
        ...
        try {
            ...
            try {
                //查询元数据，（broker list and partition info）
