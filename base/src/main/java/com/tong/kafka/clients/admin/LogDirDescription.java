...
import com.tong.kafka.common.errors.ApiException;
import com.tong.kafka.common.requests.DescribeLogDirsResponse;
...
public class LogDirDescription {
    ...
    public LogDirDescription(ApiException error, Map<TopicPartition, ReplicaInfo> replicaInfos) {
        this(error, replicaInfos, DescribeLogDirsResponse.UNKNOWN_VOLUME_BYTES, DescribeLogDirsResponse.UNKNOWN_VOLUME_BYTES);
    }
    ...
    public LogDirDescription(ApiException error, Map<TopicPartition, ReplicaInfo> replicaInfos, long totalBytes, long usableBytes) {
        ...
        this.totalBytes = (totalBytes == DescribeLogDirsResponse.UNKNOWN_VOLUME_BYTES) ? OptionalLong.empty() : OptionalLong.of(totalBytes);
        this.usableBytes = (usableBytes == DescribeLogDirsResponse.UNKNOWN_VOLUME_BYTES) ? OptionalLong.empty() : OptionalLong.of(usableBytes);
    }
