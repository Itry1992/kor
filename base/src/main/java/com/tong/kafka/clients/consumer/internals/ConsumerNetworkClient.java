...
import com.tong.kafka.common.requests.AbstractRequest;
...
public class ConsumerNetworkClient implements Closeable {
     ...
     * network until one of the {@link #poll(com.tong.kafka.common.utils.Timer)} variants is invoked. At this
     ...
     */
    public boolean awaitMetadataUpdate(com.tong.kafka.common.utils.Timer timer) {
     ...
     */
    boolean ensureFreshMetadata(com.tong.kafka.common.utils.Timer timer) {
     ...
     * @throws InterruptException if the calling thread is interrupted
     */
    public boolean poll(RequestFuture<?> future, com.tong.kafka.common.utils.Timer timer) {
     ...
     * @throws InterruptException if the calling thread is interrupted
     */
    public boolean poll(RequestFuture<?> future, com.tong.kafka.common.utils.Timer timer, boolean disableWakeup) {
        do {
     ...
     * @throws InterruptException if the calling thread is interrupted
     */
    public void poll(com.tong.kafka.common.utils.Timer timer) {
        poll(timer, null);
    }
     ...
     */
    public void poll(com.tong.kafka.common.utils.Timer timer, PollCondition pollCondition) {
     ...
     */
    public void poll(com.tong.kafka.common.utils.Timer timer, PollCondition pollCondition, boolean disableWakeup) {
    ...
    public void transmitSends() {
        com.tong.kafka.common.utils.Timer timer = time.timer(0);
     ...
     * access to {@link NetworkClient}, which means implementations must be
