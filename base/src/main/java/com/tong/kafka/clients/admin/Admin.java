...
import com.tong.kafka.common.requests.LeaveGroupResponse;

import com.tong.kafka.common.annotation.InterfaceStability;
import com.tong.kafka.common.errors.FeatureUpdateFailedException;
...
public interface Admin extends AutoCloseable {
     ...
     * all operations that have not yet been completed will be aborted with a {@link TimeoutException}.
     *
     ...
     * <ul>
     * <li>{@link ClusterAuthorizationException}
     * if the authenticated user didn't have alter access to the cluster.</li>
     * <li>{@link TopicAuthorizationException}
     * if the authenticated user didn't have alter access to the Topic.</li>
     * <li>{@link UnknownTopicOrPartitionException}
     * if the Topic doesn't exist.</li>
     * <li>{@link InvalidRequestException}
     ...
     * <li>Subclasses of {@link KafkaException}
     ...
     * <li>{@link DelegationTokenDisabledException}
     * if the delegation token feature is disabled.</li>
     * <li>{@link DelegationTokenNotFoundException}
     * if the delegation token is not found on server.</li>
     * <li>{@link DelegationTokenOwnerMismatchException}
     * if the authenticated user is not owner/renewer of the token.</li>
     * <li>{@link DelegationTokenExpiredException}
     ...
     * <li>{@link InvalidTopicException}
     * if the topic was already queued for deletion.</li>
     * <li>{@link NotControllerException}
     ...
     * <li>{@link LeaderNotAvailableException}
     ...
     *   <li>{@link InvalidReplicaAssignmentException}
     *   If the specified assignment was not valid.</li>
     *   <li>{@link NoReassignmentInProgressException}
     ...
     *   <li>{@link ClusterAuthorizationException}
     *   If the authenticated user didn't have describe access to the cluster.</li>
     *   <li>{@link ResourceNotFoundException}
     *   If the user did not exist/had no SCRAM credentials.</li>
     *   <li>{@link DuplicateResourceException}
     ...
     *   <li>{@link UnsupportedSaslMechanismException}
     *   If the requested SCRAM mechanism is unrecognized or otherwise unsupported.</li>
     *   <li>{@link UnacceptableCredentialException}
     ...
     *   <li>{@link TimeoutException}
     *   If the request timed out before the describe operation could finish.</li>
     *   <li>{@link UnsupportedVersionException}
