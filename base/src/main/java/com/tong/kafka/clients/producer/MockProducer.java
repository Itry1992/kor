...
import com.tong.kafka.clients.producer.internals.DefaultPartitioner;
import com.tong.kafka.clients.producer.internals.FutureRecordMetadata;
import com.tong.kafka.clients.producer.internals.ProduceRequestResult;
...
import com.tong.kafka.common.errors.ProducerFencedException;
...
public class MockProducer<K, V> implements Producer<K, V> {
    ...
    public MockProducer(final Cluster cluster,
                        ...
                        final Serializer<K> keySerializer,
                        final Serializer<V> valueSerializer) {
        this(cluster, autoComplete, new DefaultPartitioner(), keySerializer, valueSerializer);
    }
