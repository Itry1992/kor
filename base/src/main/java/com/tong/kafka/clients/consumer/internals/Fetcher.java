 ...
 */
package com.tong.kafka.clients.consumer.internals;

import com.tong.kafka.clients.*;
import com.tong.kafka.clients.consumer.*;
import com.tong.kafka.clients.consumer.OffsetOutOfRangeException;
...
import com.tong.kafka.common.message.FetchResponseData;
import com.tong.kafka.common.message.ListOffsetsRequestData;
import com.tong.kafka.common.metrics.Gauge;
import com.tong.kafka.common.metrics.Sensor;
import com.tong.kafka.common.metrics.stats.*;
import com.tong.kafka.common.protocol.ApiKeys;
import com.tong.kafka.common.protocol.Errors;
import com.tong.kafka.common.record.ControlRecordType;
...
import com.tong.kafka.common.message.ApiVersionsResponseData.ApiVersion;
...
public class Fetcher<K, V> implements Closeable {
     ...
     */
    public Map<String, List<PartitionInfo>> getAllTopicMetadata(com.tong.kafka.common.utils.Timer timer) {
     ...
     * @return The map of topics with their partition information
     */
    public Map<String, List<PartitionInfo>> getTopicMetadata(MetadataRequest.Builder request, com.tong.kafka.common.utils.Timer timer) {
    ...
    public Map<TopicPartition, OffsetAndTimestamp> offsetsForTimes(Map<TopicPartition, Long> timestampsToSearch,
                                                                   com.tong.kafka.common.utils.Timer timer) {
    ...
    public Map<TopicPartition, Long> beginningOffsets(Collection<TopicPartition> partitions, com.tong.kafka.common.utils.Timer timer) {
        return beginningOrEndOffset(partitions, ListOffsetsRequest.EARLIEST_TIMESTAMP, timer);
    }

    public Map<TopicPartition, Long> endOffsets(Collection<TopicPartition> partitions, com.tong.kafka.common.utils.Timer timer) {
