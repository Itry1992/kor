...
import com.tong.kafka.clients.ClientDnsLookup;
import com.tong.kafka.common.IsolationLevel;
import com.tong.kafka.common.config.AbstractConfig;
import com.tong.kafka.common.config.ConfigDef;
import com.tong.kafka.common.config.ConfigException;
import com.tong.kafka.common.config.SecurityConfig;
import com.tong.kafka.common.errors.InvalidConfigurationException;
...
import static com.tong.kafka.clients.consumer.StickyAssignor.STICKY_ASSIGNOR_NAME;
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG,
                                ...
                                .define(SEND_BUFFER_CONFIG,
                                        ConfigDef.Type.INT,
                                        128 * 1024,
                                        ConfigDef.Range.atLeast(CommonClientConfigs.SEND_BUFFER_LOWER_BOUND),
                                        ConfigDef.Importance.MEDIUM,
                                        CommonClientConfigs.SEND_BUFFER_DOC)
                                .define(RECEIVE_BUFFER_CONFIG,
                                        ConfigDef.Type.INT,
                                        64 * 1024,
                                        ConfigDef.Range.atLeast(CommonClientConfigs.RECEIVE_BUFFER_LOWER_BOUND),
                                        ConfigDef.Importance.MEDIUM,
                                ...
                                .define(AUTO_OFFSET_RESET_CONFIG,
                                        ...
                                        ConfigDef.ValidString.in(Utils.enumOptions(OffsetResetStrategy.class)),
                                        ConfigDef.Importance.MEDIUM,
                                ...
                                .define(METRICS_RECORDING_LEVEL_CONFIG,
                                        ...
                                        ConfigDef.ValidString.in(Sensor.RecordingLevel.INFO.toString(), Sensor.RecordingLevel.DEBUG.toString(), Sensor.RecordingLevel.TRACE.toString()),
                                        ConfigDef.Importance.LOW,
                                ...
                                .define(ISOLATION_LEVEL_CONFIG,
                                        ...
                                        ConfigDef.ValidString.in(IsolationLevel.READ_COMMITTED.toString().toLowerCase(Locale.ROOT), IsolationLevel.READ_UNCOMMITTED.toString().toLowerCase(Locale.ROOT)),
                                        ConfigDef.Importance.MEDIUM,
                                        ISOLATION_LEVEL_DOC)
                                ...
                                .define(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG,
                                        ...
                                        ConfigDef.ValidString.in(Utils.enumOptions(SecurityProtocol.class)),
                                        ConfigDef.Importance.MEDIUM,
