...
import com.tong.kafka.common.{Cluster, MetricName}
import com.tong.kafka.common.metrics._
import com.tong.kafka.common.metrics.Metrics
import com.tong.kafka.common.metrics.stats.{Avg, CumulativeSum, Rate}
import com.tong.kafka.common.security.auth.KafkaPrincipal
import com.tong.kafka.common.utils.{Sanitizer, Time}
import com.tong.kafka.server.quota.{ClientQuotaCallback, ClientQuotaEntity, ClientQuotaType}
import kafka.quota.ClientQuotaManager.{ClientIdEntity, DefaultClientIdEntity, DefaultClientIdQuotaEntity, DefaultTags, DefaultUserClientIdQuotaEntity, DefaultUserEntity, DefaultUserQuotaEntity, KafkaQuotaEntity, UserEntity}
...
class ClientQuotaManager(private val config: ClientQuotaManagerConfig,
  ...
  private val throttledChannelReaper = new ThrottledChannelReaper(delayQueue, threadNamePrefix)
